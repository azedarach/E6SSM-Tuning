...
// File generated at Sun 24 Aug 2014 16:10:24

#ifndef lowE6SSM_SLHA_IO_H
#define lowE6SSM_SLHA_IO_H
...
public:
   ...
   void fill(lowE6SSM_input_parameters&) const;
   template <class T> void fill(lowE6SSM<T>&) const;
   void fill(Spectrum_generator_settings&) const;
   double get_input_scale() const;
   double get_parameter_output_scale() const;
   void read_from_file(const std::string&);
   void set_extpar(const lowE6SSM_input_parameters&);
   void set_minpar(const lowE6SSM_input_parameters&);
   void set_sminputs(const softsusy::QedQcd&);
   template <class T> void set_spectrum(const lowE6SSM<T>&);
   void set_spinfo(const Problems<lowE6SSM_info::NUMBER_OF_PARTICLES>&);
   void write_to_file(const std::string&);
   void write_to_stream(std::ostream& ostr = std::cout) { slha_io.write_to_stream(ostr); }

   static void fill_minpar_tuple(lowE6SSM_input_parameters&, int, double);
   static void fill_extpar_tuple(lowE6SSM_input_parameters&, int, double);
...
private:
   ...
   static void convert_to_slha_convention(lowE6SSM_physical&);
   void set_mass(const lowE6SSM_physical&, bool);
   void set_mixing_matrices(const lowE6SSM_physical&, bool);
   template <class T> void set_model_parameters(const lowE6SSM<T>&);
   double read_scale() const;
   template <class T> void fill_drbar_parameters(lowE6SSM<T>&) const;
   template <class T> void fill_physical(lowE6SSM<T>&) const;
};
 ...
 */
template <class T>
void lowE6SSM_slha_io::fill(lowE6SSM<T>& model) const
{
 ...
 */
template <class T>
void lowE6SSM_slha_io::fill_drbar_parameters(lowE6SSM<T>& model) const
{
 ...
 */
template <class T>
void lowE6SSM_slha_io::fill_physical(lowE6SSM<T>& model) const
{
   {
      DEFINE_PARAMETER(ZD);
 ...
 */
template <class T>
void lowE6SSM_slha_io::set_model_parameters(const lowE6SSM<T>& model)
{
   {
 ...
 */
template <class T>
void lowE6SSM_slha_io::set_spectrum(const lowE6SSM<T>& model)
{
   lowE6SSM_physical physical(model.get_physical());
