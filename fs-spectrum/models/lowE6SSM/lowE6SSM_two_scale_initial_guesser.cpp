...
lowE6SSM_initial_guesser<Two_scale>::lowE6SSM_initial_guesser(
   lowE6SSM<Two_scale>* model_,
 ...
 */
void lowE6SSM_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void lowE6SSM_initial_guesser<Two_scale>::guess_susy_parameters()
{
 ...
 * corrections).
 */
void lowE6SSM_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void lowE6SSM_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void lowE6SSM_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void lowE6SSM_initial_guesser<Two_scale>::guess_soft_parameters()
{
