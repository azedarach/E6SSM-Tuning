...
#ifndef lowE6SSM_TWO_SCALE_INITIAL_GUESSER_H
#define lowE6SSM_TWO_SCALE_INITIAL_GUESSER_H

#include "lowE6SSM_initial_guesser.hpp"
...
/**
 * @class lowE6SSM_initial_guesser<Two_scale>
 * @brief initial guesser for the lowE6SSM
 */

template<>
class lowE6SSM_initial_guesser<Two_scale> : public Initial_guesser<Two_scale> {
public:
   lowE6SSM_initial_guesser(lowE6SSM<Two_scale>*,
...
private:
   lowE6SSM<Two_scale>* model; ///< pointer to model class
   lowE6SSM_input_parameters input_pars;
