...
// File generated at Sun 24 Aug 2014 16:10:03
 ...
 */
Eigen::Matrix<double,3,3> lowE6SSM_soft_parameters::calc_beta_TYe_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> lowE6SSM_soft_parameters::calc_beta_TYe_two_loop(const Soft_traces& soft_traces) const
{
   const auto Qep = INPUT(Qep);
