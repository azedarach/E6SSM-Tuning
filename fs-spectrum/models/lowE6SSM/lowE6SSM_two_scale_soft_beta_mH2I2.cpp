 ...
 */
Eigen::Matrix<double,2,2> lowE6SSM_soft_parameters::calc_beta_mH2I2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,2,2> lowE6SSM_soft_parameters::calc_beta_mH2I2_two_loop(const Soft_traces& soft_traces) const
{
   const auto QH2p = INPUT(QH2p);
