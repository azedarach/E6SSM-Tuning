 ...
 */
double lowE6SSM_soft_parameters::calc_beta_mHpbar2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double lowE6SSM_soft_parameters::calc_beta_mHpbar2_two_loop(const Soft_traces& soft_traces) const
{
   const auto QHpbarp = INPUT(QHpbarp);
