...
// File generated at Sun 24 Aug 2014 16:10:00
...
lowE6SSM_soft_parameters::lowE6SSM_soft_parameters(const lowE6SSM_input_parameters& input_)
   : lowE6SSM_susy_parameters(input_)
...
lowE6SSM_soft_parameters::lowE6SSM_soft_parameters(
   const lowE6SSM_susy_parameters& susy_model
   ...
   : lowE6SSM_susy_parameters(susy_model)
...
Eigen::ArrayXd lowE6SSM_soft_parameters::beta() const
{
   return calc_beta().get();
}

lowE6SSM_soft_parameters lowE6SSM_soft_parameters::calc_beta() const
{
...
const Eigen::ArrayXd lowE6SSM_soft_parameters::get() const
{
   Eigen::ArrayXd pars(lowE6SSM_susy_parameters::get());
...
void lowE6SSM_soft_parameters::print(std::ostream& ostr) const
{
   lowE6SSM_susy_parameters::print(ostr);
...
void lowE6SSM_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   lowE6SSM_susy_parameters::set(pars);
...
void lowE6SSM_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
...
std::ostream& operator<<(std::ostream& ostr, const lowE6SSM_soft_parameters& soft_pars)
{
