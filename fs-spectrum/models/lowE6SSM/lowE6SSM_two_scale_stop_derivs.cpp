...
namespace flexiblesusy {
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dg1_dg1(stop_mass which_stop) const
   {
      ...
      double tmp_1 = 0.15 * (Sqr(vd) - Sqr(vu));
      double tmp_2 = (0.0625 * Sqr(g1) * Sqr(Sqr(vd) - Sqr(vu)) 
                      - 0.25 * (Sqr(vd) - Sqr(vu)) * 
                      (mq222 - mu222 + 0.125 * Sqr(g2) * Sqr(vd) - 0.125 * 
                       Sqr(g1) * Sqr(vd) - 0.125 * Sqr(g2) * Sqr(vu) + 0.125 *
                       Sqr(g1) * Sqr(vu) + 0.5 * QQp * Sqr(gN) *
      ...
      double tmp_3 = (0.0625 * Sqr(g1) * Sqr(Sqr(vd) - Sqr(vu)) 
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dg2_dg1(stop_mass which_stop) const
   {
      ...
      double tmp_1 = 0.;
      double tmp_2 = -(0.0625 * g1 * g2 * Sqr(Sqr(vd) - Sqr(vu))) / Sqrt(rt);
      double tmp_3 = -(0.0625 * g1 * g2 * Sqr(Sqr(vd) - Sqr(vu)) 
                       * Sqr(mq222 - mu222 + 0.125 * Sqr(g2) * Sqr(vd) - 0.125 * 
                             Sqr(g1) * Sqr(vd) - 0.125 * Sqr(g2) * Sqr(vu) + 0.125 *
                             Sqr(g1) * Sqr(vu) + 0.5 * QQp * Sqr(gN) *
                             (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs))
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dgN_dg1(stop_mass which_stop) const
   {
      ...
      double tmp_3 = -(0.25 * g1 * (Sqr(vd) - Sqr(vu)) 
                       * (QQp * gN * (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs))
                          - Qup * gN * (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs)))
                       * Sqr(mq222 - mu222 + 0.125 * Sqr(g2) * Sqr(vd) - 0.125 * 
                             Sqr(g1) * Sqr(vd) - 0.125 * Sqr(g2) * Sqr(vu) + 0.125 *
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dYu22_dg1(stop_mass which_stop) const
   {
      ...
      double tmp_1 = 0.;
      double tmp_2 = 0.;
      double tmp_3 = (0.35355339059327373 * g1 * vd * vs * (Sqr(vd) - Sqr(vu))
                      * (mq222 - mu222 + 0.125 * Sqr(g2) * Sqr(vd) - 0.125 * 
                         Sqr(g1) * Sqr(vd) - 0.125 * Sqr(g2) * Sqr(vu) + 0.125 *
                         Sqr(g1) * Sqr(vu) + 0.5 * QQp * Sqr(gN) *
                         (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs))
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dmq222_dg1(stop_mass which_stop) const
   {
      ...
      double tmp_1 = 0.;
      double tmp_2 = -(0.25 * g1 * (Sqr(vd) - Sqr(vu))) / Sqrt(rt);
      double tmp_3 = -(0.25 * g1 * (Sqr(vd) - Sqr(vu))
                      * Sqr(mq222 - mu222 + 0.125 * Sqr(g2) * Sqr(vd) - 0.125 * 
                            Sqr(g1) * Sqr(vd) - 0.125 * Sqr(g2) * Sqr(vu) + 0.125 *
                            Sqr(g1) * Sqr(vu) + 0.5 * QQp * Sqr(gN) *
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dTYu22_dg1(stop_mass which_stop) const
   {
      ...
      double tmp_1 = 0.;
      double tmp_2 = 0.;
      double tmp_3 = -(0.5 * g1 * vu * (Sqr(vd) - Sqr(vu))
                      * (mq222 - mu222 + 0.125 * Sqr(g2) * Sqr(vd) - 0.125 * 
                         Sqr(g1) * Sqr(vd) - 0.125 * Sqr(g2) * Sqr(vu) + 0.125 *
                         Sqr(g1) * Sqr(vu) + 0.5 * QQp * Sqr(gN) *
                         (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs))
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dgN_dgN(stop_mass which_stop) const
   {
      ...
      double tmp_1 = QQp * (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs))
         + Qup * (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs));
      double tmp_2 = (Sqr(QQp * gN * (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs))
                          - Qup * gN * (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs)))
                      + (QQp * (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs))
                         - Qup * (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs))) * 
                      (mq222 - mu222 + 0.125 * Sqr(g2) * Sqr(vd) - 0.125 * 
                       Sqr(g1) * Sqr(vd) - 0.125 * Sqr(g2) * Sqr(vu) + 0.125 *
                       Sqr(g1) * Sqr(vu) + 0.5 * QQp * Sqr(gN) *
                       ...
                       - 0.5 * Qup * Sqr(gN) * (QH1p * Sqr(vd) + QH2p * 
                                                Sqr(vu) + QSp * Sqr(vs)))) / Sqrt(rt);
      double tmp_3 = (Sqr(QQp * gN * (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs))
                          - Qup * gN * (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs)))
                      * Sqr(mq222 - mu222 + 0.125 * Sqr(g2) * Sqr(vd) - 0.125 * 
                            Sqr(g1) * Sqr(vd) - 0.125 * Sqr(g2) * Sqr(vu) + 0.125 *
                            Sqr(g1) * Sqr(vu) + 0.5 * QQp * Sqr(gN) *
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dYu22_dgN(stop_mass which_stop) const
   {
      ...
      double tmp_1 = 0.;
      double tmp_2 = 0.;
      double tmp_3 = -(1.4142135623730951 * vd * vs *
                       (QQp * gN * (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs))
                        - Qup * gN * (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs)))
                       * (mq222 - mu222 + 0.125 * Sqr(g2) * Sqr(vd) - 0.125 * 
                          Sqr(g1) * Sqr(vd) - 0.125 * Sqr(g2) * Sqr(vu) + 0.125 *
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dTYu22_dgN(stop_mass which_stop) const
   {
      ...
      double tmp_1 = 0.;
      double tmp_2 = 0.;
      double tmp_3 = (2.0 * vu * (QQp * gN * (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs))
                                  - Qup * gN * (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs)))
                      * (mq222 - mu222 + 0.125 * Sqr(g2) * Sqr(vd) - 0.125 * 
                         Sqr(g1) * Sqr(vd) - 0.125 * Sqr(g2) * Sqr(vu) + 0.125 *
                         Sqr(g1) * Sqr(vu) + 0.5 * QQp * Sqr(gN) *
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dYu22_dYu22(stop_mass which_stop) const
   {
      ...
      double tmp_1 = 2.0 * Sqr(vu);
      double tmp_2 = (Sqr(vd) * Sqr(vs) * Sqr(Lambdax)) / Sqrt(rt);
      double tmp_3 = (2.0 * Sqr(vd) * Sqr(vs) * Sqr(Lambdax)
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dLambdax_dYu22(stop_mass which_stop) const
   {
      ...
      double tmp_1 = 0.;
      double tmp_2 = (Sqr(vd) * Sqr(vs) * yt * Lambdax
                      - 1.4142135623730951 * vd * vs * 
                      (TYu22 * vu - 0.7071067811865475 * vd * vs * yt * Lambdax)) / Sqrt(rt);
      double tmp_3 = (2.0 * Sqr(vd) * Sqr(vs) * yt * Lambdax
                      * Sqr(TYu22 * vu - 0.7071067811865475 * vd * vs * yt * Lambdax))
         / (rt * Sqrt(rt));
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dTYu22_dYu22(stop_mass which_stop) const
   {
      ...
      double tmp_1 = 0.;
      double tmp_2 = (-1.4142135623730951 * vd * vs * vu * Lambdax) / Sqrt(rt);
      double tmp_3 = -(2.8284271247461903 * vd * vs * vu * Lambdax
                      * Sqr(TYu22 * vu - 0.7071067811865475 * vd * vs * yt * Lambdax))
         / (rt * Sqrt(rt));
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dmq222_dmq222(stop_mass which_stop) const
   {
      ...
      double tmp_1 = 0.;
      double tmp_2 = 1.0 / Sqrt(rt);
      double tmp_3 = (Sqr(mq222 - mu222 + 0.125 * Sqr(g2) * Sqr(vd) - 0.125 * 
                         Sqr(g1) * Sqr(vd) - 0.125 * Sqr(g2) * Sqr(vu) + 0.125 *
                         Sqr(g1) * Sqr(vu) + 0.5 * QQp * Sqr(gN) *
                         (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs))
                         - 0.5 * Qup * Sqr(gN) * (QH1p * Sqr(vd) + QH2p * 
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dTYu22_dmq222(stop_mass which_stop) const
   {
      ...
      double tmp_1 = 0.;
      double tmp_2 = 0.;
      double tmp_3 = (2.0 * vu * (mq222 - mu222 + 0.125 * Sqr(g2) * Sqr(vd) - 0.125 * 
                         Sqr(g1) * Sqr(vd) - 0.125 * Sqr(g2) * Sqr(vu) + 0.125 *
                         Sqr(g1) * Sqr(vu) + 0.5 * QQp * Sqr(gN) *
                         (QH1p * Sqr(vd) + QH2p * Sqr(vu) + QSp * Sqr(vs))
                         - 0.5 * Qup * Sqr(gN) * (QH1p * Sqr(vd) + QH2p * 
   ...
   double lowE6SSM_ew_derivs::deriv_d2MStop2_dTYu22_dTYu22(stop_mass which_stop) const
   {
      ...
      double tmp_1 = 0.;
      double tmp_2 = (2.0 * Sqr(vu)) / Sqrt(rt);
      double tmp_3 = (4.0 * Sqr(vu)
                      * Sqr(TYu22 * vu - 0.7071067811865475 * vd * vs * yt * Lambdax))
         / (rt * Sqrt(rt));
