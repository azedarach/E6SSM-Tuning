...
namespace flexiblesusy {
   ...
   bool lowE6SSM_tuning_calculator::calculate_fine_tunings_using_rge_derivs()
   {
      ...
      const Eigen::Array<double,1,num_tuning_pars> vs_derivs = vev_derivs.row(2);
      std::cerr << std::setw(12) << std::left << input_scale << ' '
                ...
                << std::setw(12) << std::left << coeffs(0,1) << ' '
                << std::setw(12) << std::left << coeffs(0,2) << ' '
                << std::setw(12) << std::left << coeffs(0,3) << ' '
                << std::setw(12) << std::left << coeffs(0,4) << ' '
                << std::setw(12) << std::left << coeffs(0,5) << ' '
                << std::setw(12) << std::left << coeffs(0,6) << ' '
                << std::setw(12) << std::left << coeffs(0,7) << ' '
                << std::setw(12) << std::left << coeffs(0,8) << ' '
                << std::setw(12) << std::left << coeffs(0,9) << ' '
                << std::setw(12) << std::left << coeffs(0,10) << ' '
                << std::setw(12) << std::left << coeffs(0,11) << ' '
                << std::setw(12) << std::left << coeffs(1,0) << ' '
                << std::setw(12) << std::left << coeffs(1,1) << ' '
                << std::setw(12) << std::left << coeffs(1,2) << ' '
                << std::setw(12) << std::left << coeffs(1,3) << ' '
                << std::setw(12) << std::left << coeffs(1,4) << ' '
                << std::setw(12) << std::left << coeffs(1,5) << ' '
                << std::setw(12) << std::left << coeffs(1,6) << ' '
                << std::setw(12) << std::left << coeffs(1,7) << ' '
                << std::setw(12) << std::left << coeffs(1,8) << ' '
                << std::setw(12) << std::left << coeffs(1,9) << ' '
                << std::setw(12) << std::left << coeffs(1,10) << ' '
                << std::setw(12) << std::left << coeffs(1,11) << ' '
                << std::setw(12) << std::left << coeffs(2,0) << ' '
                << std::setw(12) << std::left << coeffs(2,1) << ' '
                << std::setw(12) << std::left << coeffs(2,2) << ' '
                << std::setw(12) << std::left << coeffs(2,3) << ' '
                << std::setw(12) << std::left << coeffs(2,4) << ' '
                << std::setw(12) << std::left << coeffs(2,5) << ' '
                << std::setw(12) << std::left << coeffs(2,6) << ' '
                << std::setw(12) << std::left << coeffs(2,7) << ' '
                << std::setw(12) << std::left << coeffs(2,8) << ' '
                << std::setw(12) << std::left << coeffs(2,9) << ' '
                << std::setw(12) << std::left << coeffs(2,10) << ' '
                << std::setw(12) << std::left << coeffs(2,11) << ' '
                << std::setw(12) << std::left << beta_derivs(0,0) << ' '
                << std::setw(12) << std::left << beta_derivs(1,0) << ' '
                << std::setw(12) << std::left << beta_derivs(2,0) << ' '
                << std::setw(12) << std::left << beta_derivs(3,0) << ' '
                << std::setw(12) << std::left << beta_derivs(4,0) << ' '
                << std::setw(12) << std::left << beta_derivs(5,0) << ' '
                << std::setw(12) << std::left << beta_derivs(6,0) << ' '
                << std::setw(12) << std::left << beta_derivs(7,0) << ' '
                << std::setw(12) << std::left << beta_derivs(8,0) << ' '
                << std::setw(12) << std::left << beta_derivs(9,0) << ' '
                << std::setw(12) << std::left << beta_derivs(10,0) << ' '
                ...
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::Lambdax, vs_derivs) << ' '
                << std::setw(12) << std::left << beta_derivs(0,1) << ' '
                << std::setw(12) << std::left << beta_derivs(1,1) << ' '
                << std::setw(12) << std::left << beta_derivs(2,1) << ' '
                << std::setw(12) << std::left << beta_derivs(3,1) << ' '
                << std::setw(12) << std::left << beta_derivs(4,1) << ' '
                << std::setw(12) << std::left << beta_derivs(5,1) << ' '
                << std::setw(12) << std::left << beta_derivs(6,1) << ' '
                << std::setw(12) << std::left << beta_derivs(7,1) << ' '
                << std::setw(12) << std::left << beta_derivs(8,1) << ' '
                << std::setw(12) << std::left << beta_derivs(9,1) << ' '
                << std::setw(12) << std::left << beta_derivs(10,1) << ' '
                << std::setw(12) << std::left << beta_derivs(11,1) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::TLambdax, vd_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::TLambdax, vu_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::TLambdax, vs_derivs) << ' '
                << std::setw(12) << std::left << beta_derivs(0,2) << ' '
                << std::setw(12) << std::left << beta_derivs(1,2) << ' '
                << std::setw(12) << std::left << beta_derivs(2,2) << ' '
                << std::setw(12) << std::left << beta_derivs(3,2) << ' '
                << std::setw(12) << std::left << beta_derivs(4,2) << ' '
                << std::setw(12) << std::left << beta_derivs(5,2) << ' '
                << std::setw(12) << std::left << beta_derivs(6,2) << ' '
                << std::setw(12) << std::left << beta_derivs(7,2) << ' '
                << std::setw(12) << std::left << beta_derivs(8,2) << ' '
                << std::setw(12) << std::left << beta_derivs(9,2) << ' '
                << std::setw(12) << std::left << beta_derivs(10,2) << ' '
                << std::setw(12) << std::left << beta_derivs(11,2) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::TYu22, vd_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::TYu22, vu_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::TYu22, vs_derivs) << ' '
                << std::setw(12) << std::left << beta_derivs(0,3) << ' '
                << std::setw(12) << std::left << beta_derivs(1,3) << ' '
                << std::setw(12) << std::left << beta_derivs(2,3) << ' '
                << std::setw(12) << std::left << beta_derivs(3,3) << ' '
                << std::setw(12) << std::left << beta_derivs(4,3) << ' '
                << std::setw(12) << std::left << beta_derivs(5,3) << ' '
                << std::setw(12) << std::left << beta_derivs(6,3) << ' '
                << std::setw(12) << std::left << beta_derivs(7,3) << ' '
                << std::setw(12) << std::left << beta_derivs(8,3) << ' '
                << std::setw(12) << std::left << beta_derivs(9,3) << ' '
                << std::setw(12) << std::left << beta_derivs(10,3) << ' '
                << std::setw(12) << std::left << beta_derivs(11,3) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::mq222, vd_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::mq222, vu_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::mq222, vs_derivs) << ' '
                << std::setw(12) << std::left << beta_derivs(0,4) << ' '
                << std::setw(12) << std::left << beta_derivs(1,4) << ' '
                << std::setw(12) << std::left << beta_derivs(2,4) << ' '
                << std::setw(12) << std::left << beta_derivs(3,4) << ' '
                << std::setw(12) << std::left << beta_derivs(4,4) << ' '
                << std::setw(12) << std::left << beta_derivs(5,4) << ' '
                << std::setw(12) << std::left << beta_derivs(6,4) << ' '
                << std::setw(12) << std::left << beta_derivs(7,4) << ' '
                << std::setw(12) << std::left << beta_derivs(8,4) << ' '
                << std::setw(12) << std::left << beta_derivs(9,4) << ' '
                << std::setw(12) << std::left << beta_derivs(10,4) << ' '
                << std::setw(12) << std::left << beta_derivs(11,4) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::mHd2, vd_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::mHd2, vu_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::mHd2, vs_derivs) << ' '
                << std::setw(12) << std::left << beta_derivs(0,5) << ' '
                << std::setw(12) << std::left << beta_derivs(1,5) << ' '
                << std::setw(12) << std::left << beta_derivs(2,5) << ' '
                << std::setw(12) << std::left << beta_derivs(3,5) << ' '
                << std::setw(12) << std::left << beta_derivs(4,5) << ' '
                << std::setw(12) << std::left << beta_derivs(5,5) << ' '
                << std::setw(12) << std::left << beta_derivs(6,5) << ' '
                << std::setw(12) << std::left << beta_derivs(7,5) << ' '
                << std::setw(12) << std::left << beta_derivs(8,5) << ' '
                << std::setw(12) << std::left << beta_derivs(9,5) << ' '
                << std::setw(12) << std::left << beta_derivs(10,5) << ' '
                << std::setw(12) << std::left << beta_derivs(11,5) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::mHu2, vd_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::mHu2, vu_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::mHu2, vs_derivs) << ' '
                << std::setw(12) << std::left << beta_derivs(0,6) << ' '
                << std::setw(12) << std::left << beta_derivs(1,6) << ' '
                << std::setw(12) << std::left << beta_derivs(2,6) << ' '
                << std::setw(12) << std::left << beta_derivs(3,6) << ' '
                << std::setw(12) << std::left << beta_derivs(4,6) << ' '
                << std::setw(12) << std::left << beta_derivs(5,6) << ' '
                << std::setw(12) << std::left << beta_derivs(6,6) << ' '
                << std::setw(12) << std::left << beta_derivs(7,6) << ' '
                << std::setw(12) << std::left << beta_derivs(8,6) << ' '
                << std::setw(12) << std::left << beta_derivs(9,6) << ' '
                << std::setw(12) << std::left << beta_derivs(10,6) << ' '
                << std::setw(12) << std::left << beta_derivs(11,6) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::mu222, vd_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::mu222, vu_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::mu222, vs_derivs) << ' '
                << std::setw(12) << std::left << beta_derivs(0,7) << ' '
                << std::setw(12) << std::left << beta_derivs(1,7) << ' '
                << std::setw(12) << std::left << beta_derivs(2,7) << ' '
                << std::setw(12) << std::left << beta_derivs(3,7) << ' '
                << std::setw(12) << std::left << beta_derivs(4,7) << ' '
                << std::setw(12) << std::left << beta_derivs(5,7) << ' '
                << std::setw(12) << std::left << beta_derivs(6,7) << ' '
                << std::setw(12) << std::left << beta_derivs(7,7) << ' '
                << std::setw(12) << std::left << beta_derivs(8,7) << ' '
                << std::setw(12) << std::left << beta_derivs(9,7) << ' '
                << std::setw(12) << std::left << beta_derivs(10,7) << ' '
                << std::setw(12) << std::left << beta_derivs(11,7) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::ms2, vd_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::ms2, vu_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::ms2, vs_derivs) << ' '
                << std::setw(12) << std::left << beta_derivs(0,8) << ' '
                << std::setw(12) << std::left << beta_derivs(1,8) << ' '
                << std::setw(12) << std::left << beta_derivs(2,8) << ' '
                << std::setw(12) << std::left << beta_derivs(3,8) << ' '
                << std::setw(12) << std::left << beta_derivs(4,8) << ' '
                << std::setw(12) << std::left << beta_derivs(5,8) << ' '
                << std::setw(12) << std::left << beta_derivs(6,8) << ' '
                << std::setw(12) << std::left << beta_derivs(7,8) << ' '
                << std::setw(12) << std::left << beta_derivs(8,8) << ' '
                << std::setw(12) << std::left << beta_derivs(9,8) << ' '
                << std::setw(12) << std::left << beta_derivs(10,8) << ' '
                << std::setw(12) << std::left << beta_derivs(11,8) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::MassB, vd_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::MassB, vu_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::MassB, vs_derivs) << ' '
                << std::setw(12) << std::left << beta_derivs(0,9) << ' '
                << std::setw(12) << std::left << beta_derivs(1,9) << ' '
                << std::setw(12) << std::left << beta_derivs(2,9) << ' '
                << std::setw(12) << std::left << beta_derivs(3,9) << ' '
                << std::setw(12) << std::left << beta_derivs(4,9) << ' '
                << std::setw(12) << std::left << beta_derivs(5,9) << ' '
                << std::setw(12) << std::left << beta_derivs(6,9) << ' '
                << std::setw(12) << std::left << beta_derivs(7,9) << ' '
                << std::setw(12) << std::left << beta_derivs(8,9) << ' '
                << std::setw(12) << std::left << beta_derivs(9,9) << ' '
                << std::setw(12) << std::left << beta_derivs(10,9) << ' '
                << std::setw(12) << std::left << beta_derivs(11,9) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::MassWB, vd_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::MassWB, vu_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::MassWB, vs_derivs) << ' '
                << std::setw(12) << std::left << beta_derivs(0,10) << ' '
                << std::setw(12) << std::left << beta_derivs(1,10) << ' '
                << std::setw(12) << std::left << beta_derivs(2,10) << ' '
                << std::setw(12) << std::left << beta_derivs(3,10) << ' '
                << std::setw(12) << std::left << beta_derivs(4,10) << ' '
                << std::setw(12) << std::left << beta_derivs(5,10) << ' '
                << std::setw(12) << std::left << beta_derivs(6,10) << ' '
                << std::setw(12) << std::left << beta_derivs(7,10) << ' '
                << std::setw(12) << std::left << beta_derivs(8,10) << ' '
                << std::setw(12) << std::left << beta_derivs(9,10) << ' '
                << std::setw(12) << std::left << beta_derivs(10,10) << ' '
                << std::setw(12) << std::left << beta_derivs(11,10) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::MassG, vd_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::MassG, vu_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::MassG, vs_derivs) << ' '
                << std::setw(12) << std::left << beta_derivs(0,11) << ' '
                << std::setw(12) << std::left << beta_derivs(1,11) << ' '
                << std::setw(12) << std::left << beta_derivs(2,11) << ' '
                << std::setw(12) << std::left << beta_derivs(3,11) << ' '
                << std::setw(12) << std::left << beta_derivs(4,11) << ' '
                << std::setw(12) << std::left << beta_derivs(5,11) << ' '
                << std::setw(12) << std::left << beta_derivs(6,11) << ' '
                << std::setw(12) << std::left << beta_derivs(7,11) << ' '
                << std::setw(12) << std::left << beta_derivs(8,11) << ' '
                << std::setw(12) << std::left << beta_derivs(9,11) << ' '
                << std::setw(12) << std::left << beta_derivs(10,11) << ' '
                << std::setw(12) << std::left << beta_derivs(11,11) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::MassBp, vd_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::MassBp, vu_derivs) << ' '
                << std::setw(12) << std::left << get_deriv(lowE6SSM_info::MassBp, vs_derivs) << ' '
                ...
                << std::setw(12) << std::left << input_scale_pars[lowE6SSM_info::MassG] << ' '
                << std::setw(12) << std::left << input_scale_pars[lowE6SSM_info::mHd2] << ' '
                << std::setw(12) << std::left << input_scale_pars[lowE6SSM_info::mHu2] << ' '
                << std::setw(12) << std::left << input_scale_pars[lowE6SSM_info::ms2] << ' '
                << std::setw(12) << std::left << input_scale_pars[lowE6SSM_info::mq222] << ' '
                << std::setw(12) << std::left << input_scale_pars[lowE6SSM_info::mu222] << ' '
                << std::setw(12) << std::left << input_scale_pars[lowE6SSM_info::TYu22] << ' '
                << '\n';
