...
void fill_default_input_pars(DoubleVector & pars)
{
   ...
   if (use_default_pars) {
      ...
      pars(1) = 2.60790587e+02;//4.35809794e+02; //< M1
      pars(3) = 1.31226477e+03;//1160.0;//2.09996302e+03; //< M3
      pars(12) = -5.70724514e+03;//-1.92476064e+03; //< AYd(2,2)
      pars(13) = -5.05791595e+03;//-8.31473226e+01; //< AYe(2,2)
      pars(31) = 2.51908311e+03;//2.28409908e+03; //< ml(0,0)
      pars(32) = 2.51900237e+03;//2.28406934e+03; //< ml(1,1)
      pars(33) = 2.49491895e+03;//2.27516902e+03; //< ml(2,2)
      pars(34) = 2.50486775e+03;//2.22578992e+03; //< me(0,0)
      pars(35) = 2.50470462e+03;//2.22572861e+03; //< me(1,1)
      pars(36) = 2.45578715e+03;//2.20733853e+03; //< me(2,2)
      pars(41) = 2.71434477e+03;//2.86004800e+03; //< mq(0,0)
      pars(42) = 2.71431844e+03;//2.86003809e+03; //< mq(1,1)
      pars(44) = 2.70274992e+03;//2.81426818e+03; //< mu(0,0)
      pars(45) = 2.70272422e+03;//2.81425727e+03; //< mu(1,1)
      pars(46) = 8.12548392e+02;//1.99865480e+03; //< mu(2,2)
      pars(47) = 2.70165286e+03;//2.80871491e+03; //< md(0,0)
      pars(48) = 2.70162523e+03;//2.80870549e+03; //< md(1,1)
      pars(49) = 2.65232920e+03;//2.79059537e+03; //< md(2,2)
   }
