...
#define BOOST_TEST_MODULE test_lowE6SSM_Lambdax_2lp_beta
...
BOOST_AUTO_TEST_CASE( test_2lp_beta_Lambdax_gN_Yd22_coeff )
{
   ...
   std::vector<lowE6SSM_info::Parameters> parameters_to_zero
      = {lowE6SSM_info::Yd00, lowE6SSM_info::Yd01, lowE6SSM_info::Yd02
         ...
         , lowE6SSM_info::Yd20, lowE6SSM_info::Yd21, lowE6SSM_info::Ye00
         , lowE6SSM_info::Ye01, lowE6SSM_info::Ye02, lowE6SSM_info::Ye10
         , lowE6SSM_info::Ye11, lowE6SSM_info::Ye12, lowE6SSM_info::Ye20
         , lowE6SSM_info::Ye21, lowE6SSM_info::Ye22, lowE6SSM_info::Yu00
         , lowE6SSM_info::Yu01, lowE6SSM_info::Yu02, lowE6SSM_info::Yu10
         , lowE6SSM_info::Yu11, lowE6SSM_info::Yu12, lowE6SSM_info::Yu20
         , lowE6SSM_info::Yu21, lowE6SSM_info::Yu22, lowE6SSM_info::Kappa00
         ...
         , lowE6SSM_info::MuPr, lowE6SSM_info::g1, lowE6SSM_info::g2
   ...
   for (std::size_t i = 0; i < num_terms; ++i) {
      ...
      model.set_Yd(2,2,distribution(generator));
      ...
      lambdax_2lp_beta = (betas_2lp.get_Lambdax() - betas_1lp.get_Lambdax()) 
         / (twoLoop * model.get_Lambdax());

      // add row to matrix of values
      coefficients(i, 0) = Power(model.get_Lambdax(), 4);
      coefficients(i, 1) = Power(model.get_gN(), 4);
      coefficients(i, 2) = Power(model.get_Yd(2,2), 4);
      coefficients(i, 3) = Sqr(model.get_Lambdax()) * Sqr(model.get_gN());
      coefficients(i, 4) = Sqr(model.get_Lambdax()) * Sqr(model.get_Yd(2,2));
      coefficients(i, 5) = Sqr(model.get_gN()) * Sqr(model.get_Yd(2,2));
   ...
   const double gN4_coeff = 2.0 * (2.0 * Power(inputs.QH1p, 4) + 2.0 * Power(inputs.QH2p, 4)
                                   + 2.0 * Power(inputs.QSp, 4) + 
                                   (Sqr(inputs.QH1p) + Sqr(inputs.QH2p) + Sqr(inputs.QSp)) * charges_sum);
   const double yb4_coeff = -9.;
   const double lambdax2gN2_coeff = 4.0 * Sqr(inputs.QSp)
      - 4.0 * (Sqr(inputs.QSp) - Sqr(inputs.QH1p) - Sqr(inputs.QH2p));
   const double lambdax2yb2_coeff = -9.;
   const double gN2yb2_coeff = -6.0 * (Sqr(inputs.QH1p) - Sqr(inputs.QQp) - Sqr(inputs.Qdp));

   BOOST_REQUIRE((coefficients * x).isApprox(rhs));
   BOOST_CHECK_LE(Abs(x(0) - lambdax4_coeff), max_err);
   BOOST_CHECK_LE(Abs(x(1) - gN4_coeff), max_err);
   BOOST_CHECK_LE(Abs(x(2) - yb4_coeff), max_err);
   BOOST_CHECK_LE(Abs(x(3) - lambdax2gN2_coeff), max_err);
   BOOST_CHECK_LE(Abs(x(4) - lambdax2yb2_coeff), max_err);
   BOOST_CHECK_LE(Abs(x(5) - gN2yb2_coeff), max_err);
...
BOOST_AUTO_TEST_CASE( test_2lp_beta_Lambdax_gN_g1_coeff )
{
   ...
   std::vector<lowE6SSM_info::Parameters> parameters_to_zero
      = {lowE6SSM_info::Yd00, lowE6SSM_info::Yd01, lowE6SSM_info::Yd02
         ...
         , lowE6SSM_info::Yu20, lowE6SSM_info::Yu21, lowE6SSM_info::Yu22
         , lowE6SSM_info::Kappa00, lowE6SSM_info::Kappa01, lowE6SSM_info::Kappa02
         , lowE6SSM_info::Kappa10, lowE6SSM_info::Kappa11, lowE6SSM_info::Kappa12
         , lowE6SSM_info::Kappa20, lowE6SSM_info::Kappa21, lowE6SSM_info::Kappa22
         , lowE6SSM_info::Lambda1200, lowE6SSM_info::Lambda1201, lowE6SSM_info::Lambda1210
         , lowE6SSM_info::Lambda1211, lowE6SSM_info::MuPr, lowE6SSM_info::g2
         , lowE6SSM_info::g3, lowE6SSM_info::vd, lowE6SSM_info::vu
         , lowE6SSM_info::vs};
   ...
   for (std::size_t i = 0; i < num_terms; ++i) {
      ...
      coefficients(i, 3) = Sqr(model.get_Lambdax()) * Sqr(model.get_gN());
      coefficients(i, 4) = Sqr(model.get_Lambdax()) * Sqr(model.get_g1());
   ...
   const double gN2g12_coeff = 1.2 * (Sqr(inputs.QH1p) + Sqr(inputs.QH2p) + (inputs.QH2p - inputs.QH1p) * mixed_charges_sum);;
   ...
   BOOST_CHECK_LE(Abs(x(3) - lambdax2gN2_coeff), max_err);
   BOOST_CHECK_LE(Abs(x(4) - lambdax2g12_coeff), max_err);
