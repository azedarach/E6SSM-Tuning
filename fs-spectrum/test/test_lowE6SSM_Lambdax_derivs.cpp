...
#define BOOST_TEST_MODULE test_lowE6SSM_Lambdax_derivs
...
double beta_fn(double x, void * params)
{
   ...
   return beta_fns.get_Lambdax();

}

BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_Lambdax_dLambdax )
{
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_Lambdax_dLambdax )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::Lambdax;
...
double leading_log_coeff(double x, void * params)
{
   ...
   return calc.calculate_leading_log_coefficient(lowE6SSM_info::Lambdax);

}

BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_Lambdax_dLambdax )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::Lambdax;
