...
#define BOOST_TEST_MODULE test_lowE6SSM_TLambdax_derivs
...
double beta_fn(double x, void * params)
{
   ...
   if (p == lowE6SSM_info::Lambdax) {
      ...
      if (is_zero(model->get_TLambdax())) {
         ...
         throw DivideByZeroError("in test_lowE6SSM_TLambdax_derivs::beta_fn");
      } else {
   ...
   return beta_fns.get_TLambdax();

}

BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_TLambdax_dLambdax )
{
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_TLambdax_dALambdax )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_TLambdax_dAYu22 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_TLambdax_dMassB )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_TLambdax_dMassWB )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_TLambdax_dMassG )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_TLambdax_dMassBp )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_TLambdax_dLambdax )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_TLambdax_dALambdax )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_TLambdax_dAYu22 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_TLambdax_dMassB )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_TLambdax_dMassWB )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_TLambdax_dMassG )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_TLambdax_dMassBp )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
double leading_log_coeff(double x, void * params)
{
   ...
   if (p == lowE6SSM_info::Lambdax) {
      ...
      if (is_zero(model->get_TLambdax())) {
         ...
         throw DivideByZeroError("in test_lowE6SSM_TLambdax_derivs::leading_log_coeff");
      } else {
         Alambda = model->get_TLambdax() / model->get_Lambdax();
      }
   ...
   return calc.calculate_leading_log_coefficient(lowE6SSM_info::TLambdax);

}

BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_TLambdax_dLambdax )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_TLambdax_dALambdax )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_TLambdax_dAYu22 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_TLambdax_dMassB )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_TLambdax_dMassWB )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_TLambdax_dMassG )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_TLambdax_dMassBp )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
