...
#define BOOST_TEST_MODULE test_lowE6SSM_mq222_derivs
...
double beta_fn(double x, void * params)
{
   ...
   if (p == lowE6SSM_info::Lambdax) {
      ...
      if (is_zero(model->get_TLambdax())) {
         ...
         throw DivideByZeroError("in test_lowE6SSM_mq222_derivs::beta_fn");
      } else {
   ...
   return beta_fns.get_mq2(2,2);

}

BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_mq222_dLambdax )
{
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_mq222_dALambdax )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_mq222_dAYu22 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_mq222_dmq222 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_mq222_dmHd2 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_mq222_dmHu2 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_mq222_dmu222 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_mq222_dms2 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_mq222_dMassB )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_mq222_dMassWB )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_mq222_dMassG )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_one_loop_mq222_dMassBp )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_mq222_dLambdax )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_mq222_dALambdax )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_mq222_dAYu22 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_mq222_dmq222 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_mq222_dmHd2 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_mq222_dmHu2 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_mq222_dmu222 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_mq222_dms2 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_mq222_dMassB )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_mq222_dMassWB )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_mq222_dMassG )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dbeta_two_loop_mq222_dMassBp )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
double leading_log_coeff(double x, void * params)
{
   ...
   if (p == lowE6SSM_info::Lambdax) {
      ...
      if (is_zero(model->get_TLambdax())) {
         ...
         throw DivideByZeroError("in test_lowE6SSM_mq222_derivs::leading_log_coeff");
      } else {
         Alambda = model->get_TLambdax() / model->get_Lambdax();
      }
   ...
   return calc.calculate_leading_log_coefficient(lowE6SSM_info::mq222);

}

BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_mq222_dLambdax )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_mq222_dALambdax )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_mq222_dAYu22 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_mq222_dmq222 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_mq222_dmHd2 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_mq222_dmHu2 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_mq222_dmu222 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_mq222_dms2 )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_mq222_dMassB )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_mq222_dMassWB )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_mq222_dMassG )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dleading_log_one_loop_mq222_dMassBp )
{
   const double max_err = 1.0e-5;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
