// ====================================================================
// Test suite for implementation of first derivatives of DR bar
// stop masses
// ====================================================================
...
#define BOOST_TEST_MODULE test_lowE6SSM_stop_first_derivs
...
double mst2(double x, void * params)
{
   ...
   derivs->get_model().calculate_MSu_3rd_generation(msf21, msf22, theta);
   
   msf21 = Sqr(msf21);
   msf22 = Sqr(msf22);

   if (stop == lowE6SSM_ew_derivs::stop_mass::mstop_1) {
      return (msf21 < msf22 ? msf21 : msf22);
   } else {
      return (msf21 < msf22 ? msf22 : msf21);
   }

}

BOOST_AUTO_TEST_CASE( test_dMFstop21_dYu22 )
{
   ...
   double analytic_deriv = ew_derivs.deriv_dMStop2_dparam(stop, p);

   mtop_params pars = {&ew_derivs, p, stop };

   gsl_function func = { mst2, &pars };
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dYu22 )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::Yu22;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::vu;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::vd;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dvs )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dvs )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::vs;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dg1 )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dg1 )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::g1;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dg2 )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dg2 )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::g2;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dgN )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dgN )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::gN;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dmq222 )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dmq222 )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dmu222 )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dmu222 )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mu222;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dLambdax )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dLambdax )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::Lambdax;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dTYu22 )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dTYu22 )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TYu22;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dTLambdax )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dTLamdbax )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TLambdax;
