...
// stop masses with respect to vd and any other parameter
// ====================================================================
...
#define BOOST_TEST_MODULE test_lowE6SSM_stop_vd_second_derivs
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dvd_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::vd;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dvu_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dvu_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::vu;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dvs_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dvs_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::vs;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dg1_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dg1_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::g1;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dg2_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dg2_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::g2;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dgN_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dgN_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::gN;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dYu22_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dYu22_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::Yu22;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dmq222_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dmq222_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dmu222_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dmu222_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mu222;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dLambdax_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dLambdax_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::Lambdax;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dTYu22_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dTYu22_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TYu22;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dTYd22_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TYd22;
   const lowE6SSM_info::Parameters q = lowE6SSM_info::vd;
   const lowE6SSM_ew_derivs::stop_mass stop = lowE6SSM_ew_derivs::stop_mass::mstop_1;
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dTYd22_dvd )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TYd22;
