...
// stop masses with respect to vu and any other parameter
// ====================================================================
...
#define BOOST_TEST_MODULE test_lowE6SSM_stop_vu_second_derivs
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dvd_dvu )
{
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dvd_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::vd;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dvu_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dvu_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::vu;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dvs_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dvs_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::vs;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dg1_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dg1_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::g1;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dg2_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dg2_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::g2;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dgN_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dgN_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::gN;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dYu22_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dYu22_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::Yu22;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dmq222_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dmq222_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mq222;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dmu222_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dmu222_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::mu222;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dLambdax_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dLambdax_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::Lambdax;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dTYu22_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dTYu22_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::TYu22;
...
BOOST_AUTO_TEST_CASE( test_dMFstop21_dMassG_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::MassG;
   const lowE6SSM_info::Parameters q = lowE6SSM_info::vu;
   const lowE6SSM_ew_derivs::stop_mass stop = lowE6SSM_ew_derivs::stop_mass::mstop_1;
...
BOOST_AUTO_TEST_CASE( test_dMFstop22_dMassG_dvu )
{
   const double max_err = 1.0e-4;
   const double theta = ArcTan(Sqrt(15.));
   const lowE6SSM_info::Parameters p = lowE6SSM_info::MassG;
