...
// File generated at Sun 24 Aug 2014 15:41:49
...
lowE6SSM_convergence_tester<Two_scale>::lowE6SSM_convergence_tester(lowE6SSM<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<lowE6SSM<Two_scale> >(model, accuracy_goal)
{
}

lowE6SSM_convergence_tester<Two_scale>::~lowE6SSM_convergence_tester()
{
}

double lowE6SSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   const lowE6SSM<Two_scale>& ol = get_last_iteration_model();
   const lowE6SSM<Two_scale>& ne = get_model();
