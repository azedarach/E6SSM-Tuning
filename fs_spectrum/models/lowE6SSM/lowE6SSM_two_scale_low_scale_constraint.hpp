...
#ifndef lowE6SSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define lowE6SSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "lowE6SSM_low_scale_constraint.hpp"
...
template<>
class lowE6SSM_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   lowE6SSM_low_scale_constraint();
   lowE6SSM_low_scale_constraint(const lowE6SSM_input_parameters&, const QedQcd&);
   virtual ~lowE6SSM_low_scale_constraint();
   virtual void apply();
