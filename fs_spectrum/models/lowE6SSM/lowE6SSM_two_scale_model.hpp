...
// ====================================================================
/**
 * @file lowE6SSM_two_scale_model.hpp
 * @brief contains class for model with routines needed to solve boundary 
 *        value problem using the two_scale solver by solvingt EWSB 
 *        and determine the pole masses and mixings
 */
// File generated at Sun 24 Aug 2014 15:46:56

#ifndef lowE6SSM_TWO_SCALE_H
#define lowE6SSM_TWO_SCALE_H

#include "lowE6SSM_model.hpp"
...
public:
   ...
   void set_physical(const lowE6SSM_physical&);
...
private:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(lowE6SSM<Two_scale>::*Memfun_t)();
      lowE6SSM<Two_scale>* model;
      Memfun_t fun;

      Thread(lowE6SSM<Two_scale>* model_, Memfun_t fun_)
   ...
   lowE6SSM_physical physical; ///< contains the pole masses and mixings
   Problems<lowE6SSM_info::NUMBER_OF_PARTICLES> problems;
#ifdef ENABLE_THREADS
...
std::ostream& operator<<(std::ostream&, const lowE6SSM<Two_scale>&);
