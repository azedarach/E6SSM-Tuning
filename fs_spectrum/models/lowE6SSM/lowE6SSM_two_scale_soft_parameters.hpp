...
#ifndef lowE6SSM_TWO_SCALE_soft_parameters_H
#define lowE6SSM_TWO_SCALE_soft_parameters_H
...
class lowE6SSM_soft_parameters : public lowE6SSM_susy_parameters {
public:
   explicit lowE6SSM_soft_parameters(const lowE6SSM_input_parameters& input_ = lowE6SSM_input_parameters());
   lowE6SSM_soft_parameters(const lowE6SSM_susy_parameters& , const Eigen::Matrix<double,3,3>& TYd_, const Eigen::Matrix<double,3,3>&
   ...
   virtual ~lowE6SSM_soft_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual const Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);

   lowE6SSM_soft_parameters calc_beta() const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const lowE6SSM_soft_parameters&);
