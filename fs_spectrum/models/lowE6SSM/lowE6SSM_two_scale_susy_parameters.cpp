...
// File generated at Sun 24 Aug 2014 16:08:34
...
#define CLASSNAME lowE6SSM_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces

lowE6SSM_susy_parameters::lowE6SSM_susy_parameters(const lowE6SSM_input_parameters& input_)
   : Beta_function()
...
lowE6SSM_susy_parameters::lowE6SSM_susy_parameters(
   double scale_, double loops_, double thresholds_,
   const lowE6SSM_input_parameters& input_
...
Eigen::ArrayXd lowE6SSM_susy_parameters::beta() const
{
   return calc_beta().get();
}

lowE6SSM_susy_parameters lowE6SSM_susy_parameters::calc_beta() const
{
   ...
   return lowE6SSM_susy_parameters(get_scale(), get_loops(), get_thresholds(), input,
...
void lowE6SSM_susy_parameters::clear()
{
   reset();
...
const Eigen::ArrayXd lowE6SSM_susy_parameters::get() const
{
...
void lowE6SSM_susy_parameters::print(std::ostream& ostr) const
{
...
void lowE6SSM_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   Yd(0,0) = pars(0);
   Yd(0,1) = pars(1);
   Yd(0,2) = pars(2);
...
const lowE6SSM_input_parameters& lowE6SSM_susy_parameters::get_input() const
{
   return input;
}

void lowE6SSM_susy_parameters::set_input_parameters(const lowE6SSM_input_parameters& input_)
{
   input = input_;
}

void lowE6SSM_susy_parameters::calc_susy_traces(Susy_traces& susy_traces) const
{
...
std::ostream& operator<<(std::ostream& ostr, const lowE6SSM_susy_parameters& susy_pars)
{
