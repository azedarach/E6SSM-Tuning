...
#ifndef lowE6SSM_TWO_SCALE_susy_parameters_H
#define lowE6SSM_TWO_SCALE_susy_parameters_H
...
class lowE6SSM_susy_parameters : public Beta_function {
public:
   explicit lowE6SSM_susy_parameters(const lowE6SSM_input_parameters& input_ = lowE6SSM_input_parameters());
   lowE6SSM_susy_parameters(double scale_, double loops_, double thresholds_, const lowE6SSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   ...
   virtual ~lowE6SSM_susy_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual const Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);
   const lowE6SSM_input_parameters& get_input() const;
   void set_input_parameters(const lowE6SSM_input_parameters&);

   lowE6SSM_susy_parameters calc_beta() const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const lowE6SSM_susy_parameters&);
