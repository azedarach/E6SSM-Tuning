...
// File generated at Sun 24 Aug 2014 15:47:42
...
lowMSSM_high_scale_constraint<Two_scale>::lowMSSM_high_scale_constraint(const lowMSSM_input_parameters& inputPars_)
   : Constraint<Two_scale>()
   , fixed_scale(0.)
   , model(0)
...
{
   assert(model && "Error: lowMSSM_high_scale_constraint:"
