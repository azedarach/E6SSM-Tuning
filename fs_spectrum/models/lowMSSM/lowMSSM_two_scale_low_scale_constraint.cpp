...
// File generated at Sun 24 Aug 2014 15:47:43
...
lowMSSM_low_scale_constraint<Two_scale>::lowMSSM_low_scale_constraint(const lowMSSM_input_parameters& inputPars_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(0)
...
{
   assert(model && "Error: lowMSSM_low_scale_constraint:"
