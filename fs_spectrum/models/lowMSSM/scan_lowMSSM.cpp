...
// File generated at Sun 24 Aug 2014 15:48:05
...
int main()
{
   ...
   for (std::vector<double>::const_iterator it = range.begin(),
      ...
      const lowMSSM<algorithm_type>& model = spectrum_generator.get_model();
      const lowMSSM_physical& pole_masses = model.get_physical();
      const Problems<lowMSSM_info::NUMBER_OF_PARTICLES>& problems
         = spectrum_generator.get_problems();
      const double higgs = pole_masses.Mhh(1);
