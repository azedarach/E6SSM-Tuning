...
mass bounds, in Figures 2 and 4 the chargino mass limit was not imposed.  This
is because the LEP bounds are not severe enough to effect the
minimum obtainable fine tuning in the models we looked at.  On the other hand,
much higher limits set at the LHC can have a meaningful impact, as is
illustrated in  Figure 2.  Nevertheless the referee is correct in pointing out
that this should be addressed in the text.
...
points that do not lead to tachyonic sparticle masses and, in the MSSM, that
satisfy the traditional conditions in the literature for color or charge
breaking minima to be avoided.  In addition to this, we have added a remark
on page 18 to point out that imposing the LEP bound does not have an effect
on the results, but that LHC limits can have a significant impact.  We also
have added a footnote stating that it is for this reason the LEP bounds are
not imposed in Figures 2 and 4.
