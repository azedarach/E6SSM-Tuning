...
which have tachyons in the spectrum, and for the MSSM we have
additionally checked that included points satisfy known conditions for
the dangerous minima to be avoided.  This however was not commented on
...
because the LEP bounds are not severe enough to effect the minimum
obtainable fine tuning in the models we looked at and we wanted to
consider the impact of the chargino mass seperately in Figure 3. There
we show that much higher limits set at the LHC can have a meaningful
impact.  Nevertheless the referee is
correct in pointing out that this should be addressed in the text.
