...
by a set of $n$ model parameters $\{p_i\}$ and is defined at the scale $M_X$. 
For a given parameter $p$ in this set, one computes
...
$m_{H_d}^2(M_{\mathrm{SUSY}})$ [GeV$^2$] & & & $4.06\times 10^7$ & $1.04\times 10^7$ \\
$m_{H_u}^2(M_{\mathrm{SUSY}})$ [GeV$^2$] & & & $5.0\times 10^5$ & $-2.66\times 10^5$ \\
