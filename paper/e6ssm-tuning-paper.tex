...
\begin{align*}
\Sigma_{\tilde{Q}}=\sum_i \tilde{Q}_i^2=\frac{321}{40}\cos^2\theta+\frac{217}{24}\sin^2\theta+\frac{27}{8\sqrt{15}}\sin 2\theta
\end{align*}
to denote the trace over the $U(1)'$ charges, along with
\begin{align*}
\Sigma_{\tilde{Q}}^Y&=\sum_i \sqrt{\frac{5}{3}}Q_i^Y\tilde{Q}_i=-\frac{3}{\sqrt{10}}\cos\theta-\frac{1}{\sqrt{6}}\sin\theta,\\
...
\Pi_{\tilde{Q}}^Y&=\sum_i \left ( \sqrt{\frac{5}{3}}Q_i^Y\right )^2\tilde{Q}_i^2=\frac{59}{40}\cos^2\theta+\frac{31}{24}\sin^2\theta+\frac{3}{8\sqrt{15}}\sin 2\theta,\\
\Pi_{\tilde{Q}}^L&=3\tilde{Q}_1^2+3\tilde{Q}_2^2+\tilde{Q}_{H'}^2+\tilde{Q}_{\overline{H'}}^2+3\tilde{Q}_L^2+9\tilde{Q}_Q^2=\frac{39}{20}\cos^2\theta+\frac{19}{12}\sin^2\theta+\frac{3}{4\sqrt{15}}\sin 2\theta,\\
\Pi_{\tilde{Q}}^C&=\tilde{Q}_d^2+\tilde{Q}_D^2+\tilde{Q}_{\overline{D}}^2+2\tilde{Q}_Q^2+\tilde{Q}_u^2=\frac{1}{2}.
\end{align*}
...
&{}+\frac{6}{5}g_1^2g_1'^2\left ( \tilde{Q}_1^2+\tilde{Q}_2^2+\tilde{Q}_S^2 \right ) \bigg \}.\label{eq:USSMLambdaOt2Coeff}
\end{align}
\end{subequations}
...
\begin{subequations}
\begin{align}
\beta_{a_\lambda}^{(1)}&=a_\lambda \left[2\lambda ^2+2 \Sigma_\lambda +3 \Sigma_\kappa +3 y_t^2+3 y_b^2+y_{\tau }^2-3 g_2^2-\frac{3}{5} g_1^2 -2 \left ( \tilde{Q}_1^2 + \tilde{Q}_2^2 + \tilde{Q}_S^2\right )g_1'^2 \right]\nonumber\\
...
&{}\left.+4g_1'^2M_1'\left ( \tilde{Q}_1^2+\tilde{Q}_2^2+\tilde{Q}_S^2 \right )\right ],\label{eq:USSMTLambdaBetaOneLoop}\\
...
\Sigma_1'&=\sum_{i=1}^3\left ( 6\tilde{Q}_Qm_{Qi}^2+3\tilde{Q}_um_{ui}^2+3\tilde{Q}_dm_{di}^2+\tilde{Q}_em_{ei}^2+2\tilde{Q}_Lm_{Li}^2+2\tilde{Q}_2m_{H_{ui}}^2+2\tilde{Q}_1m_{H_{di}}^2\right.\nonumber\\
&\quad{}\left.+\tilde{Q}_Sm_{Si}^2+3\tilde{Q}_{\overline{D}}m_{\overline{D}_i}^2+3\tilde{Q}_Dm_{Di}^2\right )+2\tilde{Q}_{H'}m_{H'}^2+2\tilde{Q}_{\overline{H'}}m_{\overline{H'}}^2,\label{eq:USSMGaugeSigmaTerm1Pr}
\end{align}
...
&{}+2y_\tau^2\left ( m_{H_d}^2+m_{L3}^2+m_{e3}^2\right )+2a_\tau^2-6g_2^2 M_2^2-\frac{6}{5}g_1^2 M_1^2-8\tilde{Q}_1^2g_1'^2 M_1'^2\nonumber\\
&{}-\frac{3}{5}g_1^2\Sigma_1+2\tilde{Q}_1g_1'^2\Sigma_1',\label{eq:USSMmHd2BetaOneLoop}\\
...
&{}-6g_2^2M_2^2-\frac{6}{5}g_1^2M_1^2-8\tilde{Q}_2^2g_1'^2M_1'^2+\frac{3}{5}g_1^2\Sigma_1+2\tilde{Q}_2g_1'^2\Sigma_1',\label{eq:USSMmHu2BetaOneLoop}\\
...
&{}-8\tilde{Q}_S^2g_1'^2M_1'^2+2\tilde{Q}_Sg_1'^2\Sigma_1',\label{eq:USSMms2BetaOneLoop}\\
...
\begin{subequations}
\begin{align}
\beta_{y_t}^{(1)}&=y_t\left [ \lambda^2+6y_t^2+y_b^2-\frac{16}{3}g_3^2-3g_2^2-\frac{13}{15}g_1^2-2g_1'^2\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2 \right )\right ],\label{eq:USSMYu22BetaOneLoop}\\
...
&{}+2g_1'^2\left [ \lambda^2\left ( \tilde{Q}_1^2-\tilde{Q}_2^2+\tilde{Q}_S^2 \right )+2y_t^2\left ( 2\tilde{Q}_Q^2+\tilde{Q}_u^2\right )+y_b^2\left ( \tilde{Q}_1^2-\tilde{Q}_Q^2+\tilde{Q}_d^2\right )\right ]\nonumber\\
...
&{}+2g_1'^4\left [ 2\left ( \tilde{Q}_2^4+\tilde{Q}_Q^4+\tilde{Q}_u^4\right )+\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2\right )\Sigma_{\tilde{Q}}\right ]+8g_3^2g_2^2+\frac{136}{45}g_3^2g_1^2\nonumber\\
&{}+\frac{32}{3}g_3^2g_1'^2\left ( \tilde{Q}_Q^2+\tilde{Q}_u^2\right )+g_2^2g_1^2+6g_2^2g_1'^2\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2\right )\nonumber\\
&{}+\frac{2}{5}g_1^2g_1'^2\left [ 3\tilde{Q}_2^2+\frac{1}{3}\tilde{Q}_Q^2+\frac{16}{3}\tilde{Q}_u^2+\left ( 3\tilde{Q}_2+\tilde{Q}_Q-4\tilde{Q}_u\right )\Sigma_{\tilde{Q}}^Y\right ]\bigg \},\label{eq:USSMYu22BetaTwoLoop}\\
...
&{}-2g_1'^2\left [ \lambda^2 \left (\tilde{Q}_1^2+2\tilde{Q}_2^2+\tilde{Q}_S^2+\tilde{Q}_Q^2+\tilde{Q}_u^2 \right )+y_b^2\left ( \tilde{Q}_1^2+\tilde{Q}_2^2+2\tilde{Q}_Q^2+\tilde{Q}_u^2+\tilde{Q}_d^2\right )\right.\nonumber\\
&{}\left.+12y_t^2\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2\right )\right ]+\frac{128}{9}g_3^4-\frac{15}{2}g_2^4-\frac{143}{18}g_1^4\nonumber\\
&{}+2g_1'^4\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2\right )\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2-\Sigma_{\tilde{Q}}\right )+16g_3^2g_2^2+\frac{208}{45}g_3^2g_1^2\nonumber\\
&{}+\frac{32}{3}g_3^2g_1'^2\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2\right )+\frac{13}{5}g_2^2g_1^2+6g_2^2g_1'^2\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2 \right )\nonumber\\
&{}+\frac{26}{15}g_1^2g_1'^2\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2 \right )\bigg \},\label{eq:USSMYu22Ot2Coeff}
\end{align}
\end{subequations}
and those for $a_t$ read
\begin{subequations}
\begin{align}
\beta_{a_t}^{(1)}&=a_t\left [ \lambda^2+6y_t^2+y_b^2-\frac{16}{3}g_3^2-3g_2^2-\frac{13}{15}g_1^2-2g_1'^2\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2 \right )\right ]\nonumber\\
&{}+y_t\left [ 2\lambda a_\lambda + 12y_ta_t+2y_ba_b+\frac{32}{3}g_3^2M_3+6g_2^2M_2+\frac{26}{15}g_1^2M_1\right.\nonumber\\
&{}\left.+4g_1'^2M_1'\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2 \right )\right ],\label{eq:USSMTYu22BetaOneLoop}\\
...
&{}-\frac{32}{3}g_3^2M_3^2-6g_2^2M_2^2-\frac{2}{15}g_1^2M_1^2-8\tilde{Q}_Q^2g_1'^2M_1'^2+\frac{1}{5}g_1^2\Sigma_1+2\tilde{Q}_Qg_1'^2\Sigma_1',\label{eq:USSMmq222BetaOneLoop}\\
...
\begin{subequations}
\begin{align}
\beta_{m_{u3}^2}^{(1)}&=4y_t^2\left ( m_{H_u}^2+m_{Q3}^2+m_{u3}^2\right )+4a_t^2-\frac{32}{3}g_3^2M_3^2-\frac{32}{15}g_1^1M_1^2-8\tilde{Q}_u^2g_1'^2M_1'^2\nonumber\\
&{}-\frac{4}{5}g_1^2\Sigma_1+2\tilde{Q}_ug_1'^2\Sigma_1',\label{eq:USSMmu222BetaOneLoop}\\
...
&{}+8g_1'^2y_t^2\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2-\tilde{Q}_u^2\right )\left ( m_{H_u}^2+m_{Q3}^2+m_{u3}^2+2M_1'^2\right )\nonumber\\
&{}+8g_1'^2\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2-\tilde{Q}_u^2\right )\left ( a_t^2-2y_ta_tM_1'\right )-24\tilde{Q}_ug_1'^2y_t^2\left (\tilde{Q}_2m_{H_u}^2+\tilde{Q}_Qm_{Q3}^2+\tilde{Q}_um_{u3}^2\right )\nonumber\\
&{}-24\tilde{Q}_ug_1'^2y_b^2\left ( \tilde{Q}_1m_{H_d}^2+\tilde{Q}_Qm_{Q3}^2+\tilde{Q}_dm_{d3}^2\right )-8\tilde{Q}_ug_1'^2y_\tau^2\left ( \tilde{Q}_1m_{H_d}^2+\tilde{Q}_Lm_{L3}^2+\tilde{Q}_em_{e3}^2\right )\nonumber\\
&{}-12\tilde{Q}_ug_1'^2\sum_{i=1}^3\kappa_i^2\left ( \tilde{Q}_Sm_S^2+\tilde{Q}_Dm_{Di}^2+\tilde{Q}_{\overline{D}}m_{\overline{D}i}^2\right )\nonumber\\
&{}-8\tilde{Q}_ug_1'^2\sum_{i=1}^3\left ( \tilde{Q}_1m_{H_d}^2+\tilde{Q}_2m_{H_u}^2+\tilde{Q}_Sm_S^2\right )\nonumber\\
...
&{}+\frac{8}{3}\tilde{Q}_ug_3^2g_1'^2\bigg [ 16\tilde{Q}_u\left (M_1'^2+M_1'M_3+M_3^2\right )\nonumber\\
&{}+12\sum_{i=1}^3\left ( \tilde{Q}_dm_{di}^2+\tilde{Q}_Dm_{Di}^2+\tilde{Q}_{\overline{D}}m_{\overline{D}i}^2+2\tilde{Q}_Qm_{Qi}^2+\tilde{Q}_um_{ui}^2\right )\bigg ]\nonumber\\
&{}+\frac{12}{5}g_2^2g_1^2\left [ m_{H'}^2-m_{\overline{H'}}^2+\sum_{i=1}^3\left ( m_{H_i^d}^2-m_{H_i^u}^2+m_{Li}^2-m_{Qi}^2\right )\right ]\nonumber\\
&{}+12\tilde{Q}_ug_2^2g_1'^2\left [ \tilde{Q}_{H'}m_{H'}^2+\tilde{Q}_{\overline{H'}}m_{\overline{H'}}^2+\sum_{i=1}^3\left ( \tilde{Q}_1m_{H_i^d}^2+\tilde{Q}_2m_{H_i^u}^2+\tilde{Q}_Lm_{Li}^2+3\tilde{Q}_Qm_{Qi}^2\right )\right ]\nonumber\\
...
&{}+\frac{4}{15}g_1^2g_1'^2\bigg [ -8\tilde{Q}_u\big ( 9\tilde{Q}_d+9\tilde{Q}_{\overline{D}}-9\tilde{Q}_D+9\tilde{Q}_e-9\tilde{Q}_1+9\tilde{Q}_2+3\tilde{Q}_{\overline{H'}}-3\tilde{Q}_{H'}-9\tilde{Q}_L\nonumber\\
&{}+9\tilde{Q}_Q-22\tilde{Q}_u\big )\left ( M_1^2+M_1M_1'+M_1'^2 \right )+12\tilde{Q}_{H'}^2m_{H'}^2-\tilde{Q}_{\overline{H'}}^2m_{\overline{H'}}^2\nonumber\\
&{}+12\sum_{i=1}^3\big ( -\tilde{Q}_d^2m_{di}^2-\tilde{Q}_{\overline{D}}^2m_{\overline{D}i}^2+\tilde{Q}_D^2m_{Di}^2-\tilde{Q}_e^2m_{ei}^2+\tilde{Q}_1^2m_{H_i^d}^2-\tilde{Q}_2^2m_{H_i^u}^2+\tilde{Q}_L^2m_{Li}^2\nonumber\\
&{}-\tilde{Q}_Q^2m_{Qi}^2+\tilde{Q}_u^2m_{ui}^2\big )-15\tilde{Q}_{\overline{H'}}\tilde{Q}_um_{\overline{H'}}^2+33\tilde{Q}_{H'}\tilde{Q}_um_{H'}^2+\tilde{Q}_u\sum_{i=1}^3\big ( -18\tilde{Q}_dm_{di}^2\nonumber\\
&{}-18\tilde{Q}_{\overline{D}}m_{\overline{D}i}^2+30\tilde{Q}_Dm_{Di}^2-6\tilde{Q}_em_{ei}^2+33\tilde{Q}_1m_{H_i^d}^2-15\tilde{Q}_2m_{H_i^u}^2+33\tilde{Q}_Lm_{Li}^2\nonumber\\
&{}-21\tilde{Q}_Qm_{Qi}^2+84\tilde{Q}_um_{ui}^2\big )\bigg ]+8\tilde{Q}_ug_1'^4\bigg [ 3\tilde{Q}_uM_1'^2\big ( 9\tilde{Q}_d^2+9\tilde{Q}_{\overline{D}}^2+9\tilde{Q}_D^2+3\tilde{Q}_e^2+6\tilde{Q}_1^2\nonumber\\
&{}+6\tilde{Q}_2^2+2\tilde{Q}_{\overline{H'}}^2+2\tilde{Q}_{H'}^2+6\tilde{Q}_L^2+18\tilde{Q}_Q^2+3\tilde{Q}_S^2+11\tilde{Q}_u^2 \big )+2\tilde{Q}_{H'}^3m_{H'}^2+2\tilde{Q}_{\overline{H'}}^3m_{\overline{H'}}^2\nonumber\\
&{}+\sum_{i=1}^3\big ( 3\tilde{Q}_d^3m_{di}^2+3\tilde{Q}_{\overline{D}}^3m_{\overline{D}i}^2+3\tilde{Q}_D^3m_{Di}^2+\tilde{Q}_e^3m_{ei}^2+2\tilde{Q}_1^3m_{H_i^d}^2+2\tilde{Q}_2^3m_{H_i^u}^2+2\tilde{Q}_L^3m_{Li}^2\nonumber\\
&{}+6\tilde{Q}_Q^3m_{Qi}^2+\tilde{Q}_S^3m_{Si}^2+3\tilde{Q}_u^3m_{ui}^2\big )+2\tilde{Q}_u\tilde{Q}_{H'}^2m_{H'}^2+2\tilde{Q}_u\tilde{Q}_{\overline{H'}}^2m_{\overline{H'}}^2\nonumber\\
&{}+\tilde{Q}_u\sum_{i=1}^3\big ( 3\tilde{Q}_d^2m_{di}^2+3\tilde{Q}_{\overline{D}}^2m_{\overline{D}i}^2+3\tilde{Q}_D^2m_{Di}^2+\tilde{Q}_e^2m_{ei}^2+2\tilde{Q}_1^2m_{H_i^d}^2+2\tilde{Q}_2^2m_{H_i^u}^2+2\tilde{Q}_L^2m_{Li}^2\nonumber\\
&{}+6\tilde{Q}_Q^2m_{Qi}^2+\tilde{Q}_S^2m_{Si}^2+3\tilde{Q}_u^2m_{ui}^2\big )\bigg ],\label{eq:USSMmu222BetaTwoLoop}\\
