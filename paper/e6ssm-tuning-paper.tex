...
to $5$ TeV.  We also impose several theoretical constraints on the points
...
\footnote{It is for this reason that we did not require the LEP bounds be
satisfied for the points shown in Figure \ref{Fig:e6ssmvsmssm}
and in Figure \ref{Fig:othere6modelsvsmssm} below.}.  Significantly larger
lower bounds on the $\mu$ parameter, and therefore on the fine tuning, may
arise from chargino limits coming from LHC searches.  However the chargino
limits from the LHC depend on whether there are light sleptons or sneutrinos
and the mass difference between the lightest chargino and lightest neutralino.
