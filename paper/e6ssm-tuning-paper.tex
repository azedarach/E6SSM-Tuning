...
\end{eqnarray}
with $f_1,f_2,f_3$ as given in Eq. (\ref{eq:E6EWSBConditions}). For a running parameter $q$ appearing in the tree level EWSB conditions, the corresponding contribution to the sensitivity coefficient may be written 
\be
...
\be
C=\frac{1}{2}\Big ( z_1\frac{\partial f_1}{\partial M_Z}+z_2\frac{\partial f_2}{\partial M_Z}+z_3\frac{\partial f_3}{\partial M_Z}\Big ).
