...
&{}+Q_{H'}+3Q_L+Q_Q+8Q_u\big )-\Sigma_1\big ( 3Q_d+3Q_{\overline{D}}-3Q_D+3Q_e-3Q_1+3Q_2+Q_{\overline{H'}}-Q_{H'}\nonumber\\
&{}-3Q_L+3Q_Q-6Q_u\big )\Big ]-4Q_Sg_1'^4\Big [ 2M_1'^2\big ( 9Q_d^3+9Q_{\overline{D}}^3+9Q_D^3+3Q_e^3+6Q_1^3+6Q_2^3+2Q_{\overline{H'}}^3\nonumber\\
&{}+2Q_{H'}^3+6Q_L^3+18Q_Q^3+3Q_S^3+9Q_u^3\big )+\left ( 6Q_SM_1'^2-\Sigma_1'\right )\Sigma_Q\Big ].\label{eq:USSMms2Ot2Coeff}
\end{align}
\end{subequations}
...
&{}+3Q_Q^2-6Q_u^2\big )-\left ( 6Q_Q\Sigma_1+\Sigma_1'\right )\big ( 3Q_d+3Q_{\overline{D}}-3Q_D+3Q_e-3Q_1+3Q_2+Q_{\overline{H'}}\nonumber\\
&{}-Q_{H'}-3Q_L+3Q_Q-6Q_u\big )\big ]-4Q_Qg_1'^4\big [ 2M_1'^2\big ( 9Q_d^3+9Q_{\overline{D}}^3+9Q_D^3+3Q_e^3+6Q_1^3\nonumber\\
