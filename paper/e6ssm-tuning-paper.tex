...
\caption{Scatter plot of fine tuning vs lightest Higgs mass in the MSSM with $m_{\chi^\pm_1} = 200$ GeV shown in green 
(bottom band) $m_{\chi^\pm_1} = 500$ GeV in blue (middle band) and $m_{\chi^\pm_1} = 700$ GeV in red
(top band).}
