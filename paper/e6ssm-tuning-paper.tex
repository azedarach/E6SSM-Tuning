...
%% However for the results we present
%%  here we set the SARAH flag NoU1Mixing to true to avoid generating
%%  unmanageably large expressions.  It has previously been checked that
%%  when these models are evolved down from the GUT scale the radiatively
%%  generated gauge kinetic mixing gives an off diagonal gauge coupling,
%%  $g_{11}$ of just $\approx 0.02$ at the electroweak scale
%%  \cite{King:2005jy} and so it does not play a large role.
