...
tuning of $\approx 100 - 1000$ and the minimum tuning we find \footnote{Note that in the calculation of the Higgs mass there is a significant theoretical error, even with leading two-loop corrections, which should be considered when thuinking about what the results imply for the miniumum fine tuining in the model consistent with the recent discovery of a 125 GeV Higgs.}
