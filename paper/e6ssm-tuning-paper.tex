...
under which the right handed neutrino remains interactionless as
E$_6$SSM-variants\cite{Howl:2007zi, Braam:2009fi,
  Braam:2010sy, Hall:2011zq, Nevzorov:2012hs, Athron:2014pua}, with the E$_6$SSM reserved for the original
formualtion of this model \cite{King:2005jy,King:2005my,Athron:2010zz}
...
very widely in the literature \cite{Gunion:1989we, Gunion:1992hs,
  ...
  Keith:1997zb, Gherghetta:1996yr, Demir:1998dk,L angacker:1998tc,
...
In this paper we will focus a lot on a very well motivated $E_6$
inspired $U(1)$ exension, the Exceptional Supersymmetric Standard
Model (E$_6$SSM)\cite{King:2005jy,King:2005my,Athron:zz}.  In this
model since the right handed neutrino remains interactionless they may
explain the tiny observed masses of neutrinos via the see-saw
mechanism andp the baryon asymmetry in the universe via leptogensis
\cite{Hambye:2000bn,King:2008qb}.
...
decoupled ``inert'' neutralino sector \cite{Hall:2009aj} no longer
seem phenomenologically viable due to limits from direct detection of
dark matter \cite{} and limits on invisible Higgs decays \cite{}.  

Alternatively one may specilaize to scenarios known as the EZSSM
\cite{Hall:2011zq} where the inert singlinos, which cause these
problems are entirely decoupled and the relic abundance is fitted with
a bino-like candidate with a novel mechanism involving back-scattering
into a Heavier inert Higgsino. Finally one may obtain...
...
In the
constrained version of the of the E$_6$SSM the particle spectrum,
collider signatures and fine tuning have been studied
\cite{cE6SSM1,cE6SSM2,cE6SSM3,cE6SSM4,Athron:2013ipa}. The threshold
corrections to the $\overline{DR}$ gauge and Yukawa couplings in the
\essm were calculated and the numerical impact in the constrained
version examined \cite{Athron:2012pw}. The impact of gauge kinetic
...
\cite{Rizzo:2012rf}.  The \essm was also included in a studies looking
...
renormalization of VEVs \cite{Sperling:2013-1, Sperling:2013-2}.
