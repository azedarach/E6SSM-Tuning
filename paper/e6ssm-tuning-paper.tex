...
supersymmtric standard models (E$_6$SSM)
...
the LHC can still constrain the most natural scenarions from just
...
$\Delta_{A_t}$ as we did in the MSSM benchmark.  [Last thing that
  ...
  at the highscales.  but i need to see the numbers to know.]
...
is sufficiently complicated by the interplay of tehse different
sources of tesnion in the EWSB conditions that a small reduction in
