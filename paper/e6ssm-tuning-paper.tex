...
\end{align*}
Note that $a_{\lambda_i}\equiv\lambda_i A_{\lambda_i}$, $a_{\kappa_i}\equiv\kappa_i A_{\kappa_i}$, $a_t\equiv y_t A_t$, $a_b\equiv y_b A_b$ and $a_\tau= y_\tau A_\tau$. Definining 
\begin{align}
...
b_{y_t}^{(2)}&=y_t\bigg \{ 108y_t^4+13y_b^4+26y_t^2y_b^2+2y_b^2y_\tau^2+\lambda^2\left ( 5\lambda^2+30y_t^2+10y_b^2+2y_\tau^2+4\Sigma_\lambda+6\Sigma_\kappa \right )\nonumber\\
&{}-\frac{32}{3}g_3^2\left ( \lambda^2+2y_b^2+12y_t^2\right )-12g_2^2\left ( \lambda^2+y_b^2+6y_t^2\right )-g_1^2\left ( \frac{44}{15}\lambda^2+\frac{8}{3}y_b^2+\frac{104}{5}y_t^2\right )\nonumber\\
&{}-4g_1'^2\left [ \lambda^2 \left (\tilde{Q}_1^2+2\tilde{Q}_2^2+\tilde{Q}_S^2+\tilde{Q}_Q^2+\tilde{Q}_u^2 \right )+y_b^2\left ( \tilde{Q}_1^2+\tilde{Q}_2^2+2\tilde{Q}_Q^2+\tilde{Q}_u^2+\tilde{Q}_d^2\right )\right.\nonumber\\
&{}\left.+12y_t^2\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2\right )\right ]+\frac{256}{9}g_3^4-15g_2^4-\frac{143}{9}g_1^4\nonumber\\
&{}+4g_1'^4\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2\right )\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2-\Sigma_{\tilde{Q}}\right )+32g_3^2g_2^2+\frac{416}{45}g_3^2g_1^2\nonumber\\
&{}+\frac{64}{3}g_3^2g_1'^2\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2\right )+\frac{26}{5}g_2^2g_1^2+12g_2^2g_1'^2\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2 \right )\nonumber\\
&{}+\frac{52}{15}g_1^2g_1'^2\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2 \right )\bigg \},\label{eq:USSMYu22Ot2Coeff}
\end{align}
\end{subequations}
and those for $a_t$ read
\begin{subequations}
\begin{align}
\beta_{a_t}^{(1)}&=,\label{eq:USSMTYu22BetaOneLoop}\\
...
\begin{subequations}
\begin{align}
\beta_{m_{Q3}^2}^{(1)}&=,\label{eq:USSMmq222BetaOneLoop}\\
...
\begin{subequations}
\begin{align}
\beta_{m_{u3}^2}^{(1)}&=,\label{eq:USSMmu222BetaOneLoop}\\
