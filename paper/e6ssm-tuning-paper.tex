...
use the leading two-loop\footnote{Two-loop corrections calculated for
  ...
  \cite{Goodsell:2014pla,Goodsell:2015ira}.} contributions from
\cite{King:2005jy} which are a generalsiation of the correctsions in
the MSSM and NMSSM calculated using effective field theory techniques
