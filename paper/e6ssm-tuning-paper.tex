...
$m_{\tilde{\chi}^\pm_1} = 200$ GeV shown in light blue (bottom band),
$m_{\tilde{\chi}^\pm_1} = 500$ GeV in dark blue (middle band), and
$m_{\tilde{\chi}^\pm_1} = 700$ GeV in dark yellow (top band).}
