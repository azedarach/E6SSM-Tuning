...
$\mu$-problem as the USSM \cite{Cvetic:1995rj, Jain:1995cb,
  Nir:1995bu, Cvetic:1996mf, Cvetic:1997ky}, but since avoiding gauge
anomalies is straightforward in the when the $U(1)$appears from the
breakdown of $E_6$ and complete matter multiplets are present at low
energies, we will sometimes refer to such models as $E_6$ inspired.
Models with with complete $E_6$ matter multiplets at low energies and
an extra $U(1)$ under which the right handed neutrino remains
interaction-less are often refered to as the exceptional supersymmtric
standard models (E$_6$SSM). However we will reserve the name E$_6$SSM
to the original formulation of models
\cite{King:2005jy,King:2005my,Athron:2010zz}, and refer to similar
models as E$_6$SSM-variants\cite{Howl:2007zi, Braam:2009fi,
  Braam:2010sy, Hall:2011zq, Nevzorov:2012hs, Athron:2014pua}.
