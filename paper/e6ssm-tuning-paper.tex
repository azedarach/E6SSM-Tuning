...
\end{align}
\end{subequations}
It is sufficient to consider the trilinear coupling $a_\lambda\equiv \lambda A_\lambda$, for which the relevant expressions read
\begin{subequations}
\begin{align}
...
\end{align*}
Note that $a_{\lambda_i}\equiv\lambda_i A_{\lambda_i}$, $a_{\kappa_i}\equiv\kappa_i A_{\kappa_i}$, $a_t\equiv y_t A_t$, $a_b\equiv y_b A_b$ and $a_\tau= y_\tau A_\tau$.
