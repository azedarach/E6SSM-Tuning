...
\begin{subequations}
\begin{align}
\beta_{a_\lambda}^{(1)}&=2\lambda \left [ 2 \Sigma_{a_\lambda}+3\Sigma_{a_\kappa}+3y_ta_t+3y_ba_b+y_\tau a_\tau+\frac{3}{5}g_1^2M_1+3g_2^2 M_2+2g_1'^2\left ( \tilde{Q}_1^2+\tilde{Q}_2^2+\tilde{Q}_S^2\right )\right ]\nonumber\\
&{}+a_\lambda \left [ 6\lambda^2+2\Sigma_\lambda+3\Sigma_\kappa+3y_t^2+3y_b^2+y_\tau^2-\frac{3}{5}g_1^2-3g_2^2-2g_1'^2\left ( \tilde{Q}_1^2+\tilde{Q}_2^2+\tilde{Q}_S^2 \right )\right ],\label{eq:USSMTLambdaBetaOneLoop}\\
...
\begin{subequations}
\begin{align}
\beta_{a_t}^{(1)}&=2y_t\left [ \lambda a_\lambda+3y_ta_t++\frac{16}{3}g_3^2M_3+3g_2^2M_2+\frac{13}{15}g_1^2M_1+2g_1'^2M_1'\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2\right )\right ]\nonumber\\
&{}+a_t\left [ \lambda^2+12y_t^2+y_b^2-\frac{16}{3}g_3^2-3g_2^2-\frac{13}{15}g_1^2-2g_1'^2\left ( \tilde{Q}_2^2+\tilde{Q}_Q^2+\tilde{Q}_u^2\right )\right ]+2y_ty_ba_b,\label{eq:USSMTYu22BetaOneLoop}\\
...
\beta_{m_{u3}^2}^{(2)}&=,\label{eq:USSMmu222BetaTwoLoop}\\
