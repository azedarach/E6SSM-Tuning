...
tuning in the MSSM with a $20$ TeV cutoff slightly worse than that of
the E$_6$SSM with the same cutoff and a $Z^\prime$ mass just larger
...
than that of the E$_6$SSM when the cutoff scale is ? 
...
\beta_\lambda^{(2)}&=\lambda \left \{ -2\lambda^2\left ( \lambda^2+2\Sigma_\lambda+3\Sigma_\kappa\right )-4\Pi_\lambda-6\Pi_\kappa-3\lambda^2\left ( 3y_t^2+3y_b^2+y_\tau^2\right )\right . \nonumber\\
...
&{}+16g_3^2\left ( y_t^2+y_b^2+\Sigma_\kappa\right ) +\frac{33}{2}g_2^4+\frac{297}{50}g_1^4+g_1'^2\left ( \tilde{Q}_1^2+\tilde{Q}_2^2+\tilde{Q}_S^2\right )+\frac{9}{5}g_1^2g_2^2+6g_1'^2g_2^2\left ( \tilde{Q}_1^2+\tilde{Q}_2^2\right )\nonumber\\
&{}\left.+\frac{6}{5}g_1^2g_1'^2\left [2\tilde{Q}_1\tilde{Q}_2+\left ( \tilde{Q}_2-\tilde{Q}_1\right )\left ( 3\tilde{Q}_d+3\tilde{Q}_e-4\tilde{Q}_1+4\tilde{Q}_2+\tilde{Q}_{\overline{H'}}-\tilde{Q}_{H'}-3\tilde{Q}_L+3\tilde{Q}_Q-6\tilde{Q}_u+3\tilde{Q}_{\overline{D}}-3\tilde{Q}_D\right )\right ]\right \},\label{eq:USSMLambdaBetaTwoLoop}
\end{align}
\end{subequations}
where
\begin{equation*}
...
\end{align*}
to denote sums over the $U(1)'$ charges.
