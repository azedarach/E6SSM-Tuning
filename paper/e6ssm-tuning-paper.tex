...
boundary condition, $M_X$ is raised. These benchmarks are defined in
table \ref{} and the results are shown in
...
parameters are defined.  This illustrates that any statement about which
model is more tuned depends on the cutoff scale considered.
