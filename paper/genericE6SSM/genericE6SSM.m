...
Model`Name = "genericE6SSM";
Model`NameLaTeX ="Generic E6SSM";
...
(* Chiral Superfields *)
(* Dylan:: Added in variable U(1)_N charges *)
SuperFields[[1]] = {q, 3, {uL,  dL},     1/6, 2, 3, QQp, RpM};  
SuperFields[[2]] = {l, 3, {vL,  eL},    -1/2, 2, 1, QLp, RpM};
SuperFields[[3]] = {Hd,1, {Hd0, Hdm},   -1/2, 2, 1, QH1p, RpP};
SuperFields[[4]] = {Hu,1, {Hup, Hu0},    1/2, 2, 1, QH2p, RpP};

SuperFields[[5]] = {d, 3, conj[dR],    1/3, 1, -3, Qdp, RpM};
SuperFields[[6]] = {u, 3, conj[uR],   -2/3, 1, -3, Qup, RpM};
SuperFields[[7]] = {e, 3, conj[eR],      1, 1,  1, Qep, RpM};
SuperFields[[8]] = {s, 1, sR,            0, 1,  1, QSp, RpP};

SuperFields[[9]] = {H1I, 2, {H1I0, H1Im},  -1/2, 2, 1, QH1p, RpP};
SuperFields[[10]] = {H2I, 2, {H2Ip, H2I0},   1/2, 2, 1, QH2p, RpP};
SuperFields[[11]] = {sI, 2, sIR,    0, 1,  1, QSp, RpP};
SuperFields[[12]] = {Dx, 3, DxL,  -1/3, 1, 3, QDxp, RpP};
SuperFields[[13]] = {Dxbar, 3, conj[DxbarR],  1/3, 1, -3, QDxbarp, RpP};

SuperFields[[14]] = {Hp,    1, {Hpd0, Hpdm},  -1/2, 2,  1, QHpp, RpP};
SuperFields[[15]] = {Hpbar, 1, {Hpup, Hpu0},   1/2, 2,  1, QHpbarp, RpP};
NoU1Mixing=True;
AddMixedSofts = False;
