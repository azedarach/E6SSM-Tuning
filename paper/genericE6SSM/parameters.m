...
{QQp, {Description -> "Left-handed quark U(1)_N charge",
       LaTeX -> "Q_Q'",
       Real -> True,
       OutputName -> QQp}},
{Qup, {Description -> "Right-handed up quark U(1)_N charge",
       LaTeX -> "Q_u'",
       Real -> True,
       OutputName -> Qup}},
{Qdp, {Description -> "Right-handed down quark U(1)_N charge",
       LaTeX -> "Q_d'",
       Real -> True,
       OutputName -> Qdp}},
{QLp, {Description -> "Left-handed lepton U(1)_N charge",
       LaTeX -> "Q_L'",
       Real -> True,
       OutputName -> QLp}},
{Qep, {Description -> "Right-handed lepton U(1)_N charge",
       LaTeX -> "Q_e'",
       Real -> True,
       OutputName -> Qep}},
{QH1p, {Description -> "Down type Higgs U(1)_N charge",
       LaTeX -> "Q_{H_1}'",
       Real -> True,
       OutputName -> QH1p}},
{QH2p, {Description -> "Up type Higgs U(1)_N charge",
       LaTeX -> "Q_{H_2}'",
       Real -> True,
       OutputName -> QH2p}},
{QSp, {Description -> "Singlet U(1)_N charge",
       LaTeX -> "Q_S'",
       Real -> True,
       OutputName -> QSp}},
{QDxp, {Description -> "Exotic quark U(1)_N charge",
       LaTeX -> "Q_X'",
       Real -> True,
       OutputName -> QDxp}},
{QDxbarp, {Description -> "Bar exotic quark U(1)_N charge",
       LaTeX -> "Q_{\\bar{X}}'",
       Real -> True,
       OutputName -> QDxbarp}},
{QHpp, {Description -> "Survival Higgs U(1)_N charge",
       LaTeX -> "Q_{H'}'",
       Real -> True,
       OutputName -> QHpp}},
{QHpbarp, {Description -> "Bar survival Higgs U(1)_N charge",
       LaTeX -> "Q_{\\bar{H}'}'",
       Real -> True,
       OutputName -> QHpbarp}}
}; 
