...
E6SSM_high_scale_constraint<Two_scale>::E6SSM_high_scale_constraint(const E6SSM_input_parameters& inputPars_)
   : Constraint<Two_scale>()
   , fixed_scale(0.)
   , model(0)
...
{
   assert(model && "Error: E6SSM_high_scale_constraint:"
