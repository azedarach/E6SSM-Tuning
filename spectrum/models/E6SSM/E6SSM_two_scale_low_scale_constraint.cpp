...
E6SSM_low_scale_constraint<Two_scale>::E6SSM_low_scale_constraint(const E6SSM_input_parameters& inputPars_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(0)
...
{
   assert(model && "Error: E6SSM_low_scale_constraint:"
