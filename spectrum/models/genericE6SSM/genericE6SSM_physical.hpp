...
#ifndef genericE6SSM_PHYSICAL_H
#define genericE6SSM_PHYSICAL_H
...
struct genericE6SSM_physical {
   genericE6SSM_physical();
   void clear();
...
std::ostream& operator<<(std::ostream&, const genericE6SSM_physical&);
