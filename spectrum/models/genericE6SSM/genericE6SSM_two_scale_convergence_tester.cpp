...
genericE6SSM_convergence_tester<Two_scale>::genericE6SSM_convergence_tester(genericE6SSM<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<genericE6SSM<Two_scale> >(model, accuracy_goal)
{
}

genericE6SSM_convergence_tester<Two_scale>::~genericE6SSM_convergence_tester()
{
}

double genericE6SSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   const genericE6SSM<Two_scale>* ol = get_last_iteration_model();
   const genericE6SSM<Two_scale>* ne = get_model();
