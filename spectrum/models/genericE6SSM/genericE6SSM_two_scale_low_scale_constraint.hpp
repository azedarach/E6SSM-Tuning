...
#ifndef genericE6SSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define genericE6SSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "genericE6SSM_low_scale_constraint.hpp"
...
template<>
class genericE6SSM_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   genericE6SSM_low_scale_constraint();
   genericE6SSM_low_scale_constraint(const genericE6SSM_input_parameters&, const QedQcd&);
   virtual ~genericE6SSM_low_scale_constraint();
   virtual void apply();
