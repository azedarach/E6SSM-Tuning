...
// File generated at Sun 15 Jun 2014 19:16:32
 ...
 */
Eigen::Matrix<double,2,2> genericE6SSM_soft_parameters::calc_beta_TLambda12_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,2,2> genericE6SSM_soft_parameters::calc_beta_TLambda12_two_loop(const Soft_traces& soft_traces) const
{
   const auto QH1p = INPUT(QH1p);
