...
// File generated at Sun 15 Jun 2014 19:16:36
 ...
 */
double genericE6SSM_soft_parameters::calc_beta_mHd2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double genericE6SSM_soft_parameters::calc_beta_mHd2_two_loop(const Soft_traces& soft_traces) const
{
   const auto QH1p = INPUT(QH1p);
