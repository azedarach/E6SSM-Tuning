 ...
 */
Eigen::Matrix<double,3,3> genericE6SSM_soft_parameters::calc_beta_md2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> genericE6SSM_soft_parameters::calc_beta_md2_two_loop(const Soft_traces& soft_traces) const
{
   const auto Qdp = INPUT(Qdp);
