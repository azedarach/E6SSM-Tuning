 ...
 */
Eigen::Matrix<double,2,2> genericE6SSM_soft_parameters::calc_beta_msI2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,2,2> genericE6SSM_soft_parameters::calc_beta_msI2_two_loop(const Soft_traces& soft_traces) const
{
   const auto QSp = INPUT(QSp);
