...
genericE6SSM_physical::genericE6SSM_physical()
   :
...
void genericE6SSM_physical::clear()
{
   MVG = 0.0;
   MGlu = 0.0;
...
void genericE6SSM_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
...
std::ostream& operator<<(std::ostream& ostr, const genericE6SSM_physical& phys_pars)
{
