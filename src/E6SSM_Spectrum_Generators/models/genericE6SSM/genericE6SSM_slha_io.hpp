...
#ifndef genericE6SSM_SLHA_IO_H
#define genericE6SSM_SLHA_IO_H

#include "genericE6SSM_two_scale_model.hpp"
#include "genericE6SSM_info.hpp"
#include "slha_io.hpp"
...
class genericE6SSM_slha_io {
public:
   genericE6SSM_slha_io();
   ~genericE6SSM_slha_io() {}

   void clear();

   void fill(QedQcd& qedqcd) const { slha_io.fill(qedqcd); }
   void fill(genericE6SSM_input_parameters&) const;
   template <class T> void fill(genericE6SSM<T>&) const;
   void fill(Spectrum_generator_settings&) const;
   double get_input_scale() const;
   double get_parameter_output_scale() const;
   void read_from_file(const std::string&);
   void set_extpar(const genericE6SSM_input_parameters&);
   void set_minpar(const genericE6SSM_input_parameters&);
   void set_sminputs(const softsusy::QedQcd&);
   template <class T> void set_spectrum(const genericE6SSM<T>&);
   void set_spinfo(const Problems<genericE6SSM_info::NUMBER_OF_PARTICLES>&);
   void write_to_file(const std::string&);
   void write_to_stream(std::ostream& ostr = std::cout) { slha_io.write_to_stream(ostr); }

   static void fill_minpar_tuple(genericE6SSM_input_parameters&, int, double);
   static void fill_extpar_tuple(genericE6SSM_input_parameters&, int, double);
   static void fill_flexiblesusy_tuple(Spectrum_generator_settings&, int, double);

private:
   SLHA_io slha_io; ///< SLHA io class

   template <class T> void set_mass(const genericE6SSM<T>&);
   template <class T> void set_mixing_matrices(const genericE6SSM<T>&);
   template <class T> void set_model_parameters(const genericE6SSM<T>&);
};
 ...
 */
template <class T>
void genericE6SSM_slha_io::fill(genericE6SSM<T>& model) const
{
...
template <class T>
void genericE6SSM_slha_io::set_mass(const genericE6SSM<T>& model)
{
...
template <class T>
void genericE6SSM_slha_io::set_mixing_matrices(const genericE6SSM<T>& model)
{
...
template <class T>
void genericE6SSM_slha_io::set_model_parameters(const genericE6SSM<T>& model)
{
   {
...
template <class T>
void genericE6SSM_slha_io::set_spectrum(const genericE6SSM<T>& model)
{
