...
genericE6SSM_initial_guesser<Two_scale>::genericE6SSM_initial_guesser(
   genericE6SSM<Two_scale>* model_,
   const genericE6SSM_input_parameters& input_pars_,
   const QedQcd& oneset_,
   const genericE6SSM_low_scale_constraint<Two_scale>& low_constraint_,
   const genericE6SSM_susy_scale_constraint<Two_scale>& susy_constraint_,
   const genericE6SSM_high_scale_constraint<Two_scale>& high_constraint_
)
...
{
   assert(model && "genericE6SSM_initial_guesser: Error: pointer to model"
          " genericE6SSM<Two_scale> must not be zero");
}
...
void genericE6SSM_initial_guesser<Two_scale>::guess()
{
...
void genericE6SSM_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
...
void genericE6SSM_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
...
void genericE6SSM_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
...
void genericE6SSM_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
...
void genericE6SSM_initial_guesser<Two_scale>::guess_soft_parameters()
{
