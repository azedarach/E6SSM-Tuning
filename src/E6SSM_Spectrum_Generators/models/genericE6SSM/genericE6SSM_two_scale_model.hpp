...
#ifndef genericE6SSM_TWO_SCALE_H
#define genericE6SSM_TWO_SCALE_H

#include "genericE6SSM_model.hpp"
#include "genericE6SSM_two_scale_soft_parameters.hpp"
#include "genericE6SSM_physical.hpp"
...
public:
   ...
   const genericE6SSM_physical& get_physical() const;
   const Problems<genericE6SSM_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<genericE6SSM_info::NUMBER_OF_PARTICLES>& get_problems();
   ...
   double get_lsp(genericE6SSM_info::Particles&) const;
   ...
   std::complex<double> CpUSuconjUSuconjSSI0SSI0(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpUSSI0conjUSSI0conjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpVZconjSHp0SHp0(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpVZconjSHppSHpp(unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpVZpconjSHp0SHp0(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpVZpconjSHppSHpp(unsigned gI1, unsigned gI2) const;
...
private:
   ...
   struct Thread {
      typedef void(genericE6SSM<Two_scale>::*Memfun_t)();
      genericE6SSM<Two_scale>* model;
      Memfun_t fun;

      Thread(genericE6SSM<Two_scale>* model_, Memfun_t fun_)
   ...
   genericE6SSM_physical physical;
   Problems<genericE6SSM_info::NUMBER_OF_PARTICLES> problems;
...
std::ostream& operator<<(std::ostream&, const genericE6SSM<Two_scale>&);
