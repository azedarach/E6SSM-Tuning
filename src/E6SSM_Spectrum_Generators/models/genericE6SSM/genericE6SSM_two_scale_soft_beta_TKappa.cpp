...
// File generated at Sun 15 Jun 2014 19:16:31
 ...
 */
Eigen::Matrix<double,3,3> genericE6SSM_soft_parameters::calc_beta_TKappa_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> genericE6SSM_soft_parameters::calc_beta_TKappa_two_loop(const Soft_traces& soft_traces) const
{
   const auto QDxbarp = INPUT(QDxbarp);
