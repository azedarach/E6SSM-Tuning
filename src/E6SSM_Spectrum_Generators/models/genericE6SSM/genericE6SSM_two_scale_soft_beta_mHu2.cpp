...
// File generated at Sun 15 Jun 2014 19:16:38
 ...
 */
double genericE6SSM_soft_parameters::calc_beta_mHu2_one_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mHu2 = oneOver16PiSqr*(0.7745966692414834*g1*Tr11 + 2*gN*QH2p*
      ...
      AbsSqr(MassWB)*Sqr(g2) - 8*AbsSqr(MassBp)*Sqr(gN)*Sqr(QH2p));
 ...
 */
double genericE6SSM_soft_parameters::calc_beta_mHu2_two_loop(const Soft_traces& soft_traces) const
{
   const auto QH2p = INPUT(QH2p);
   ...
   beta_mHu2 = twoLoop*(6*Power(g2,4)*Tr22 + 3.0983866769659336*g1*gN*
      QH2p*Tr2U114 + 3.0983866769659336*g1*gN*QH2p*Tr2U141 + 3.0983866769659336
      *g1*Tr31 + 8*gN*QH2p*Tr34 - 6*tracemd2YdAdjYuYuAdjYd - 6*
      ...
      *tracemH1I2AdjLambda12Lambda12*AbsSqr(Lambdax) - 2*traceml2AdjYeYe*AbsSqr
      ...
      traceAdjYuTYu*Conj(MassG)*Sqr(g3) + 0.04*Conj(MassB)*Sqr(g1)*(-40*
      traceAdjYuTYu + 80*MassB*traceYuAdjYu + 3*(297*MassB*Sqr(g1) + 5*(3*(2*
      MassB + MassWB)*Sqr(g2) + 4*(2*MassB + MassBp)*QH2p*(3*Qdp + 3*QDxbarp -
      3*QDxp + 3*Qep - 3*QH1p + 4*QH2p + QHpbarp - QHpp - 3*QLp + 3*QQp - 6*Qup
      )*Sqr(gN)))) + 4*mHd2*AbsSqr(Lambdax)*Sqr(gN)*Sqr(QH1p) + 4*mHu2*AbsSqr(
      ...
      gN)*Sqr(QH1p) + 8*Tr2U144*Sqr(gN)*Sqr(QH2p) - 12*traceconjTYuTpTYu*Sqr(gN
      )*Sqr(QH2p) + 12*MassBp*traceconjTYuTpYu*Sqr(gN)*Sqr(QH2p) - 12*
      tracemq2AdjYuYu*Sqr(gN)*Sqr(QH2p) - 12*tracemu2YuAdjYu*Sqr(gN)*Sqr(QH2p)
      - 12*mHu2*traceYuAdjYu*Sqr(gN)*Sqr(QH2p) - 4*mHd2*AbsSqr(Lambdax)*Sqr(gN)
      *Sqr(QH2p) - 4*mHu2*AbsSqr(Lambdax)*Sqr(gN)*Sqr(QH2p) - 4*ms2*AbsSqr(
      Lambdax)*Sqr(gN)*Sqr(QH2p) - 4*AbsSqr(TLambdax)*Sqr(gN)*Sqr(QH2p) + 4*
      MassBp*Conj(TLambdax)*Lambdax*Sqr(gN)*Sqr(QH2p) + 24*AbsSqr(MassWB)*Sqr(
      g2)*Sqr(gN)*Sqr(QH2p) + 12*MassBp*Conj(MassWB)*Sqr(g2)*Sqr(gN)*Sqr(QH2p)
      + 12*traceconjTYuTpTYu*Sqr(gN)*Sqr(QQp) - 12*MassBp*traceconjTYuTpYu*Sqr(
      gN)*Sqr(QQp) + 12*tracemq2AdjYuYu*Sqr(gN)*Sqr(QQp) + 12*tracemu2YuAdjYu*
      Sqr(gN)*Sqr(QQp) + 12*mHu2*traceYuAdjYu*Sqr(gN)*Sqr(QQp) + 4*mHd2*AbsSqr(
      Lambdax)*Sqr(gN)*Sqr(QSp) + 4*mHu2*AbsSqr(Lambdax)*Sqr(gN)*Sqr(QSp) + 4*
      ms2*AbsSqr(Lambdax)*Sqr(gN)*Sqr(QSp) + 4*AbsSqr(TLambdax)*Sqr(gN)*Sqr(QSp
      ) - 4*MassBp*Conj(TLambdax)*Lambdax*Sqr(gN)*Sqr(QSp) + 12*
      traceconjTYuTpTYu*Sqr(gN)*Sqr(Qup) - 12*MassBp*traceconjTYuTpYu*Sqr(gN)*
      Sqr(Qup) + 12*tracemq2AdjYuYu*Sqr(gN)*Sqr(Qup) + 12*tracemu2YuAdjYu*Sqr(
      gN)*Sqr(Qup) + 12*mHu2*traceYuAdjYu*Sqr(gN)*Sqr(Qup) - 12*mHd2*Sqr(Conj(
      Lambdax))*Sqr(Lambdax) - 12*mHu2*Sqr(Conj(Lambdax))*Sqr(Lambdax) - 12*ms2
      *Sqr(Conj(Lambdax))*Sqr(Lambdax) + 0.8*Conj(MassBp)*Sqr(gN)*(3*(5*
      traceAdjYuTYu*(Sqr(QH2p) - Sqr(QQp) - Sqr(Qup)) - 10*MassBp*traceYuAdjYu*
      (Sqr(QH2p) - Sqr(QQp) - Sqr(Qup)) + QH2p*((MassB + 2*MassBp)*(3*Qdp + 3*
      QDxbarp - 3*QDxp + 3*Qep - 3*QH1p + 4*QH2p + QHpbarp - QHpp - 3*QLp + 3*
      QQp - 6*Qup)*Sqr(g1) + 5*QH2p*((2*MassBp + MassWB)*Sqr(g2) + 2*MassBp*Sqr
      (gN)*(9*Sqr(Qdp) + 9*Sqr(QDxbarp) + 9*Sqr(QDxp) + 3*Sqr(Qep) + 6*Sqr(QH1p
      ) + 8*Sqr(QH2p) + 2*Sqr(QHpbarp) + 2*Sqr(QHpp) + 6*Sqr(QLp) + 18*Sqr(QQp)
      + 3*Sqr(QSp) + 9*Sqr(Qup))))) + 5*Conj(Lambdax)*(Sqr(QH1p) - Sqr(QH2p) +
      Sqr(QSp))*(2*MassBp*Lambdax - TLambdax)) - 6*traceconjTKappaTpKappa*Conj
      (Lambdax)*TLambdax - 4*traceconjTLambda12TpLambda12*Conj(Lambdax)*
