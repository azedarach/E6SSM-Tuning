...
#ifndef genericE6SSM_TWO_SCALE_soft_parameters_H
#define genericE6SSM_TWO_SCALE_soft_parameters_H
...
class genericE6SSM_soft_parameters : public genericE6SSM_susy_parameters {
public:
   explicit genericE6SSM_soft_parameters(const genericE6SSM_input_parameters& input_ = genericE6SSM_input_parameters());
   genericE6SSM_soft_parameters(const genericE6SSM_susy_parameters& , const Eigen::Matrix<double,3,3>& TYd_, const Eigen::Matrix<double,3,3>&
   ...
   virtual ~genericE6SSM_soft_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual const Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);

   genericE6SSM_soft_parameters calc_beta() const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const genericE6SSM_soft_parameters&);
