 ...
 */
double genericE6SSM_susy_parameters::calc_beta_gN_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double genericE6SSM_susy_parameters::calc_beta_gN_two_loop(const Susy_traces& susy_traces) const
{
   const auto Qdp = INPUT(Qdp);
   const auto QDxbarp = INPUT(QDxbarp);
   const auto QDxp = INPUT(QDxp);
