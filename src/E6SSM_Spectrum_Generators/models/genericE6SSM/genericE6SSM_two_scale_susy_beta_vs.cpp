 ...
 */
double genericE6SSM_susy_parameters::calc_beta_vs_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double genericE6SSM_susy_parameters::calc_beta_vs_two_loop(const Susy_traces& susy_traces) const
{
