...
#ifndef genericE6SSM_TWO_SCALE_susy_parameters_H
#define genericE6SSM_TWO_SCALE_susy_parameters_H
...
class genericE6SSM_susy_parameters : public Beta_function {
public:
   explicit genericE6SSM_susy_parameters(const genericE6SSM_input_parameters& input_ = genericE6SSM_input_parameters());
   genericE6SSM_susy_parameters(double scale_, double loops_, double thresholds_, const genericE6SSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   ...
   virtual ~genericE6SSM_susy_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual const Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);
   const genericE6SSM_input_parameters& get_input() const;
   void set_input_parameters(const genericE6SSM_input_parameters&);

   genericE6SSM_susy_parameters calc_beta() const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const genericE6SSM_susy_parameters&);
