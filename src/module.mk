...
$(ESSMTUNINGSCAN2_EXE): $(ESSMTUNINGSCAN2_OBJ) $(ESSMTUNING_OBJ) $(LIBMODEL) $(LIBFLEXI) $(LIBLEGACY) $(filter-out -%,$(LOOPFUNCLIBS))
		$(CXX) -o $@ $(call abspathx,$^) $(filter -%,$(LOOPFUNCLIBS)) $(GSLLIBS) $(BOOSTTHREADLIBS) $(THREADLIBS) $(LAPACKLIBS) $(FLIBS) $(CPPFLAGS)
...
ALLEXE += $(ESSMTUNINGSCAN_EXE) $(ESSMTUNINGSCAN2_EXE) $(ESSMGENERATOR_EXE) $(ESSMHIGGSSCAN_EXE) $(ESSMRGERUNNER_EXE)
