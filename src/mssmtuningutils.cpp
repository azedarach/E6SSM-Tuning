...
void doTestRGEApproxSolns(SoftParsMssm r)
{
   ...
   cout << "# MU: " << endl;
   cout << "# SOFTSUSY (approx) beta_mu^(1)   = ";
   printRow(cout, betamu1lp);
   cout << " (";
   printRow(cout, approxmubeta1lp);
   cout << " ), diff. = ";
   printRow(cout, mu1lpdiff);
   cout << "." << endl;
   cout << "# SOFTSUSY (approx) beta_mu^(2)   = ";
   printRow(cout, betamu2lppiece);
   cout << " (";
   printRow(cout, approxmubeta2lppiece);
   cout << " ), diff. = ";
   printRow(cout, mu2lppiecediff);
   cout << "." << endl;
   cout << "# SOFTSUSY (approx) beta_mu^(1+2) = ";
   printRow(cout, betamu2lp);
   cout << " (";
   printRow(cout, approxmubeta2lp);
   cout << " ), diff. = ";
   printRow(cout, mu2lpdiff);
   cout << "." << endl;
   cout << "# B: " << endl;
   cout << "# SOFTSUSY (approx) beta_B^(1)   = ";
   printRow(cout, betaB1lp);
   cout << " (";
   printRow(cout, approxBbeta1lp);
   cout << " ), diff. = ";
   printRow(cout, B1lpdiff);
   cout << "." << endl;
   cout << "# SOFTSUSY (approx) beta_B^(2)   = ";
   printRow(cout, betaB2lppiece);
   cout << " (";
   printRow(cout, approxBbeta2lppiece);
   cout << " ), diff. = ";
   printRow(cout, B2lppiecediff);
   cout << "." << endl;
   cout << "# SOFTSUSY (approx) beta_B^(1+2) = ";
   printRow(cout, betaB2lp);
   cout << " (";
   printRow(cout, approxBbeta2lp);
   cout << " ), diff. = ";
   printRow(cout, B2lpdiff);
   cout << "." << endl;
   cout << "# MH1SQ: " << endl;
   cout << "# SOFTSUSY (approx) beta_mHdSq^(1)   = ";
   printRow(cout, betamHdSq1lp);
   cout << " (";
   printRow(cout, approxmHdSqbeta1lp);
   cout << " ), diff. = ";
   printRow(cout, mHdSq1lpdiff);
   cout << "." << endl;
   cout << "# SOFTSUSY (approx) beta_mHdSq^(2)   = ";
   printRow(cout, betamHdSq2lppiece);
   cout << " (";
   printRow(cout, approxmHdSqbeta2lppiece);
   cout << " ), diff. = ";
   printRow(cout, mHdSq2lppiecediff);
   cout << "." << endl;
   cout << "# SOFTSUSY (approx) beta_mHdSq^(1+2) = ";
   printRow(cout, betamHdSq2lp);
   cout << " (";
   printRow(cout, approxmHdSqbeta2lp);
   cout << " ), diff. = ";
   printRow(cout, mHdSq2lpdiff);
   cout << "." << endl;
   cout << "# MH2SQ: " << endl;
   cout << "# SOFTSUSY (approx) beta_mHuSq^(1)   = ";
   printRow(cout, betamHuSq1lp);
   cout << " (";
   printRow(cout, approxmHuSqbeta1lp);
   cout << " ), diff. = ";
   printRow(cout, mHuSq1lpdiff);
   cout << "." << endl;
   cout << "# SOFTSUSY (approx) beta_mHuSq^(2)   = ";
   printRow(cout, betamHuSq2lppiece);
   cout << " (";
   printRow(cout, approxmHuSqbeta2lppiece);
   cout << " ), diff. = ";
   printRow(cout, mHuSq2lppiecediff);
   cout << "." << endl;
   cout << "# SOFTSUSY (approx) beta_mHuSq^(1+2) = ";
   printRow(cout, betamHuSq2lp);
   cout << " (";
   printRow(cout, approxmHuSqbeta2lp);
   cout << " ), diff. = ";
   printRow(cout, mHuSq2lpdiff);
   cout << "." << endl;
   cout << "# MQL3SQ: " << endl;
   cout << "# SOFTSUSY (approx) beta_mQlSq^(1)   = ";
   printRow(cout, betamQlSq1lp);
   cout << " (";
   printRow(cout, approxmQlSqbeta1lp);
   cout << " ), diff. = ";
   printRow(cout, mQlSq1lpdiff);
   cout << "." << endl;
   cout << "# SOFTSUSY (approx) beta_mQlSq^(2)   = ";
   printRow(cout, betamQlSq2lppiece);
   cout << " (";
   printRow(cout, approxmQlSqbeta2lppiece);
   cout << " ), diff. = ";
   printRow(cout, mQlSq2lppiecediff);
   cout << "." << endl;
   cout << "# SOFTSUSY (approx) beta_mQlSq^(1+2) = ";
   printRow(cout, betamQlSq2lp);
   cout << " (";
   printRow(cout, approxmQlSqbeta2lp);
   cout << " ), diff. = ";
   printRow(cout, mQlSq2lpdiff);
   cout << "." << endl;
   cout << "# MTRSQ: " << endl;
   cout << "# SOFTSUSY (approx) beta_mUrSq^(1)   = ";
   printRow(cout, betamUrSq1lp);
   cout << " (";
   printRow(cout, approxmUrSqbeta1lp);
   cout << " ), diff. = ";
   printRow(cout, mUrSq1lpdiff);
   cout << "." << endl;
   cout << "# SOFTSUSY (approx) beta_mUrSq^(2)   = ";
   printRow(cout, betamUrSq2lppiece);
   cout << " (";
   printRow(cout, approxmUrSqbeta2lppiece);
   cout << " ), diff. = ";
   printRow(cout, mUrSq2lppiecediff);
   cout << "." << endl;
   cout << "# SOFTSUSY (approx) beta_mUrSq^(1+2) = ";
   printRow(cout, betamUrSq2lp);
   cout << " (";
   printRow(cout, approxmUrSqbeta2lp);
   cout << " ), diff. = ";
   printRow(cout, mUrSq2lpdiff);
   cout << "." << endl;
   cout << "# AT: " << endl;
   cout << "# SOFTSUSY (approx) beta_At^(1)   = ";
   printRow(cout, betaAt1lp);
   cout << " (";
   printRow(cout, approxAtbeta1lp);
   cout << " ), diff. = ";
   printRow(cout, At1lpdiff);
   cout << "." << endl;
   cout << "# SOFTSUSY (approx) beta_At^(2)   = ";
   printRow(cout, betaAt2lppiece);
   cout << " (";
   printRow(cout, approxAtbeta2lppiece);
   cout << " ), diff. = ";
   printRow(cout, At2lppiecediff);
   cout << "." << endl;
   cout << "# SOFTSUSY (approx) beta_At^(1+2) = ";
   printRow(cout, betaAt2lp);
   cout << " (";
   printRow(cout, approxAtbeta2lp);
   cout << " ), diff. = ";
   printRow(cout, At2lpdiff);
   cout << "." << endl;
   cout << "#" << endl;
   ...
   cout << "# SOFTSUSY (approx) MU log^2 coeff = ";
   printRow(cout, numericalmuLogSqCoeff);
   cout << " (";
   printRow(cout, muLogSqCoeff);
   cout << " ), % error = ";
   printRow(cout, muRelErr);
   cout << " %." << endl;
   cout << "# SOFTSUSY (approx) B log^2 coeff = ";
   printRow(cout, numericalBLogSqCoeff);
   cout << " (";
   printRow(cout, BLogSqCoeff);
   cout << " ), % error = ";
   printRow(cout, BRelErr);
   cout << " %."  << endl;
   cout << "# SOFTSUSY (approx) MH1SQ log^2 coeff = ";
   printRow(cout, numericalmHdSqLogSqCoeff);
   cout << " (";
   printRow(cout, mHdSqLogSqCoeff);
   cout << " ), % error = ";
   printRow(cout, mHdSqRelErr);
   cout << " %." << endl;
   cout << "# SOFTSUSY (approx) MH2SQ log^2 coeff = ";
   printRow(cout, numericalmHuSqLogSqCoeff);
   cout << " (";
   printRow(cout, mHuSqLogSqCoeff);
   cout << " ), % error = ";
   printRow(cout, mHuSqRelErr);
   cout << " %." << endl;
   cout << "# SOFTSUSY (approx) MQL3SQ log^2 coeff = ";
   printRow(cout, numericalmQlSqLogSqCoeff);
   cout << " (";
   printRow(cout, mQlSqLogSqCoeff);
   cout << " ), % error = ";
   printRow(cout, mQlSqRelErr);
   cout << " %." << endl;
   cout << "# SOFTSUSY (approx) MTRSQ log^2 coeff = ";
   printRow(cout, numericalmUrSqLogSqCoeff);
   cout << " (";
   printRow(cout, mUrSqLogSqCoeff);
   cout << " ), % error = ";
   printRow(cout, mUrSqRelErr);
   cout << " %." << endl;
   cout << "# SOFTSUSY (approx) AT log^2 coeff = ";
   printRow(cout, numericalAtLogSqCoeff);
   cout << " (";
   printRow(cout, AtLogSqCoeff);
   cout << " ), % error = ";
   printRow(cout, AtRelErr);
   cout << " %." << endl;
   cout << "#" << endl;
